...
cc.Class({
    ...
    OnShow: function (clubId,pid,type) {
        ...
        this.unionId = sendPackHead.unionId;
        this.clubId = sendPackHead.clubId;
    ...
    OnClick:function(btnName, btnNode){
        if(btnName == "btn_close" || btnName == "img_black"){
            this.CloseForm();
        }else if(btnName == "btn_zengsong"){
            app.FormManager().ShowForm('ui/club_2/UIGameTicketChange',this.player,this.opClubId,this.clubId,this.unionId);
        }else{
