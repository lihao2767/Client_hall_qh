...
cc.Class({
    ...
    InitData:function (clubId, unionId, unionPostType, myisminister, unionName, unionSign, levelPromotion,isMinisetrZhongZhi) {
        ...
        //     let defaultToggle = this.node.getChildByName("topToggleContainer").getChildByName("toggle2");
        //     this.node.getChildByName("topToggleContainer").getChildByName("toggle3").getComponent(cc.Toggle).isChecked = true;
        //     defaultToggle.getComponent(cc.Toggle).isChecked = true;//先关闭再打开才能出发事件
        // }
        this.OnClickToggle_1();
    },
    //控件点击回调
    ...
    OnClickToggle_1:function(target){
        ...
        //this.node.getChildByName("topToggleContainer").getChildByName("toggle1").getComponent(cc.Toggle).isChecked = true;
        this.node.getChildByName("memberManageNode").getComponent("memberManageNode").InitData(this.clubId, this.unionId, this.unionPostType,this.myisminister,this.unionName, this.unionSign,this.isMinisetrZhongZhi);
    },
