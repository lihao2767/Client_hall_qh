...
cc.Class({
    ...
    onLoad:function(){
        ...
        app.Client.RegEvent("UpdateMemberExamineList", this.Event_UpdateMemberExamineList, this);
    },
    ...
    Event_UpdateMemberExamineList:function(event){
        this.GetUnionMemberExamineList(true);
    },
    ...
    OnClick:function(btnName, btnNode){
        if ("btn_search" == btnName) {
            ...
            // });
            app.FormManager().ShowForm('ui/club_2/UIExamineConfig',btnNode.parent.data,this.clubId,this.unionId);
        }
    },
});