...
cc.Class({
    ...
    OnClose:function(){
        this.node.getChildByName('img_srk').getChildByName("chazhaoEditBox").getComponent(cc.EditBox).string='';
    },
	...
	OnClick:function(btnName, btnNode){
		if('btn_close'==btnName){
            ...
            let pid1=this.node.getChildByName("img_srk").getChildByName("chazhaoEditBox").getComponent(cc.EditBox).string;
            if(pid1!=''){
                this.ShowForbid(pid1);
            }
        }else{
