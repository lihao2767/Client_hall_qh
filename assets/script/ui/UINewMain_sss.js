...
cc.Class({
    ...
    OnShow: function () {
        ...
        if (cc.sys.isNative) {
            this.ChouJiangUrl='http://8.159.141.75/index.php?module=Api&action=GetLuckGoods';
            this.WenJuanUrl="http://8.159.141.75/mu?module=Api&action=GetQuestionnaire&pid="+heroID;
            this.IpUrl='http://8.159.141.75:88/myip.php';
            this.KeFuUrl = "http://8.159.141.75/index.php?module=Api&action=Contact";
        }else{
            this.ChouJiangUrl='http://8.159.141.75/index.php?module=Api&action=GetLuckGoods';
            this.WenJuanUrl="http://8.159.141.75/mu?module=Api&action=GetQuestionnaire&pid="+heroID;
            this.IpUrl='http://8.159.141.75:88/myip.php';
