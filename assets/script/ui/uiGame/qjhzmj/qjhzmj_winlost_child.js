...
cc.Class({
	...
	ShowPlayerHuImg: function (huNode, huTypeName, isTing) {
		...
		*/
		...
		if (typeof (huType) == "undefined") {
			...
			huNode.getComponent(cc.Label).string = '热铳';
		} else {
			huNode.getComponent(cc.Label).string = '';
		}
	},
	...
	GetHuTypeDict: function () {
		let huTypeDict = {};
		huTypeDict["AnGang"] = "黑笑";
		huTypeDict["Gang"] = "回头笑";
		huTypeDict["JieGang"] = "点笑";
		huTypeDict["FengKan"] = "四风杠";
		huTypeDict["ZiMo"] = "软摸";
		huTypeDict["YingHu"] = "黑摸";
		huTypeDict["PingHu"] = "屁胡";
		huTypeDict["SiJinDao"] = "喜相逢";
		huTypeDict["GangPao"] = "热铳";
		huTypeDict["PPHu"] = "双大胡";
		huTypeDict["Jin"] = "甩癞数";
