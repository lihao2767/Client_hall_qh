...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        scoreNodes.getChildByName('lb_jiangfen').getComponent(cc.Label).string = posResultInfo.jiangPoint > 0 ? "+" + posResultInfo.jiangPoint : posResultInfo.jiangPoint;
		scoreNodes.getChildByName('lb_jianfen').getComponent(cc.Label).string = posResultInfo.count510KPoint > 0 ? "+" + posResultInfo.count510KPoint : posResultInfo.count510KPoint;
		scoreNodes.getChildByName('lb_point').getComponent(cc.Label).string = posResultInfo.point > 0 ? "+" + posResultInfo.point : posResultInfo.point;
