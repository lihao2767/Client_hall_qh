...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        scoreNodes.getChildByName('lb_zongPoint').getComponent(cc.Label).string = posResultInfo.zongPoint > 0 ? "+" + posResultInfo.zongPoint : posResultInfo.zongPoint;
		scoreNodes.getChildByName('lb_xianPai').getComponent(cc.Label).string = posResultInfo.xianPai > 0 ? "+" + posResultInfo.xianPai : posResultInfo.xianPai;
