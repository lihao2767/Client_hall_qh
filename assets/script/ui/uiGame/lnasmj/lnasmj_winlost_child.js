...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        let maiMaList = setEnd["zhongList"] || [];
    ...
    ShowPlayerInfo: function (ShowNode, PlayerInfo, HuList) {
        ...
        let danBaoFlag = HuList["danBaoFlag"];
        let duoBaoFlag = HuList["duoBaoFlag"];
        ...
        ShowNode.getChildByName('danbao').active = danBaoFlag;
        ShowNode.getChildByName('duobao').active = duoBaoFlag;
    ...
    ShowPlayerJieSuan: function (ShowNode, huInfoAll) {
        ...
        if(maiMaStr != "" || piaoHuaStr != ""){
            if(maiMaStr != "" && piaoHuaStr!= ""){
                this.ShowLabelName(ShowNode.getChildByName("scrollView").getChildByName("label_lists"), "[" + maiMaStr + " " + piaoHuaStr + "]");
            }else{
                this.ShowLabelName(ShowNode.getChildByName("scrollView").getChildByName("label_lists"), "[" + maiMaStr + piaoHuaStr + "]");
            }
        }*/
        ...
        for (let huType in huInfo) {
            ...
            this.ShowLabelName(ShowNode.getChildByName("scrollView").getChildByName('label_lists'), this.LabelName(huType) + ":" + huPoint);
