...
var pypdkChildCreateRoom = cc.Class({
    ...
    CreateSendPack:function(renshu, setCount, isSpiltRoomCard){
        ...
        let jiesanfafen = this.GetIdxByKey('jiesanfafen');
    ...
    UpdateOnClickToggle: function() {
        ...
        if(this.Toggles["jiesanfafen"]){
            if(!this.Toggles["renshu"][0].getChildByName("checkmark").active){
                this.Toggles['jiesanfafen'][0].parent.active = false;
            }else{
                this.Toggles['jiesanfafen'][0].parent.active = true;
            }
        }
    },
            ...
            if(this.gameType == this.gameCreateConfig[key].GameName){
                if(curKey == this.gameCreateConfig[key].Key){
                    ...
                    if("kexuanwanfa" == curKey){
                        ...
                        this.Toggles['kexuanwanfa'][16].serverIdx = 33;//特殊计分
                        this.Toggles['kexuanwanfa'][17].serverIdx = 34;//三张不带
