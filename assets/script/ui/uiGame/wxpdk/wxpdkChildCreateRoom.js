...
var wxpdkChildCreateRoom = cc.Class({
    ...
    OnToggleClick:function(event){
        ...
        if('jushu' == key || 'renshu' == key || 'fangfei' == key){      
            ...
            if (this.Toggles['shoupai'][0].getChildByName('checkmark').active && toggleIndex == 16) {
                app.SysNotifyManager().ShowSysMsg("仅限16张玩法可选");
                return;
            }
        }
            ...
            if(this.gameType == this.gameCreateConfig[key].GameName){
                if(curKey == this.gameCreateConfig[key].Key){
                    ...
                    if("kexuanwanfa" == curKey){
                        ...
                        this.Toggles['kexuanwanfa'][16].serverIdx = 33;//剩14、15张加扣7分等等
                        this.Toggles['kexuanwanfa'][17].serverIdx = 34;//每局必发黑桃三
    ...
    Event_RoomCfgs:function(event){
        ...
        for (let i = 0; i < this.roomCfgs.length; i++) {
            ...
            // if(gameType.toLowerCase().indexOf("wxpdk") >= 0){
                if(gameType.toLowerCase() == this.gameType){
                    this.RefreshAllToggles(this.roomCfgs[i].gameType.toLowerCase());
                }
            // }
        }
    },
            ...
            if(this.gameType == this.gameCreateConfig[key].GameName){
                ...
                for(let i=1; i<=toggleCount; i++){
                    ...
                    if(curNode){
                        ...
                        if(this.unionData == null || this.unionData.cfgData == null){
                            //如果是亲友圈
                            if(this.clubData && this.clubData.bRoomConfigure){
                                let cfgDataList = this.clubData.bRoomConfigure[dataKey];
...
module.exports = wxpdkChildCreateRoom;