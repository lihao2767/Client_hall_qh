...
cc.Class({
	...
	ShowZhongMaCards: function (cardNodes, zhongMaList, zhongList, shuList) {
		...
		for (let i = 0; i < zhongMaList.length; i++) {
			...
			if (cardNode.getChildByName("icon_ying")) {
				cardNode.getChildByName("icon_ying").active = zhongList.indexOf(cardId) > -1;
			}
	...
	GetHuTypeDict: function () {
		...
		huTypeDict["YaDang"] = "丫挡"; 
		huTypeDict["ZhiZi"] = "支子"; 
		huTypeDict["DuiPai"] = "对牌"; 
		huTypeDict["KanZi"] = "坎子"; 
		huTypeDict["AnGang"] = "暗杠"; 
		huTypeDict["MingGang"] = "明杠"; 
		huTypeDict["GSKH"] = "杠开"; 
		huTypeDict["SG"] = "双杠"; 
		huTypeDict["DaLianHao"] = "大连号"; 
		huTypeDict["ShuangLianHao"] = "双连号"; 
		huTypeDict["LianHao"] = "小连号"; 
		huTypeDict["BangBang"] = "棒棒"; 
		huTypeDict["WuTong"] = "五通"; 
		huTypeDict["LiuTong"] = "六通"; 
		huTypeDict["QiTong"] = "七通"; 
		huTypeDict["ShuangTong"] = "双通"; 
		huTypeDict["BuDongShou"] = "不动手"; 
		huTypeDict["LXD"] = "老小对"; 
		huTypeDict["LLXD"] = "两老小对"; 
		huTypeDict["SiHe"] = "四核"; 
		huTypeDict["HYS"] = "混一色"; 
		huTypeDict["DDHu"] = "对对胡"; 
		huTypeDict["SDK"] = "三大坎"; 
		huTypeDict["KuZhiYa"] = "枯枝丫"; 
		huTypeDict["DDC"] = "大吊车"; 
		huTypeDict["QD"] = "七对"; 
		huTypeDict["Hua"] = "花"; 
		huTypeDict["BaTong"] = "八通"; 
		huTypeDict["ZMDDC"] = "自摸大吊车"; 
		huTypeDict["HYSDLHBDS"] = "混一色大连号不动手"; 
		huTypeDict["LXDDDC"] = "老小对大吊车"; 
		huTypeDict["HYSDDC"] = "混一色大吊车"; 
		huTypeDict["HYSQD"] = "混一色七对"; 
		huTypeDict["LF"] = "乱风"; 
		huTypeDict["ShuangSiHe"] = "双四核"; 
		huTypeDict["QYDDHu"] = "全幺对对胡"; 
		huTypeDict["QYQD"] = "全幺七对"; 
		huTypeDict["QDSH"] = "七对四核"; 
		huTypeDict["KKH"] = "坎坎胡"; 
		huTypeDict["ShuangBaZhi"] = "双八支"; 
		huTypeDict["ShuangBangBangQD"] = "双棒棒七对"; 
		huTypeDict["ZFBSDK"] = "中发白三大坎"; 
		huTypeDict["SDKSYZ"] = "三大坎十一支"; 
		huTypeDict["SanG"] = "三杠"; 
		huTypeDict["QYS"] = "清一色"; 
		huTypeDict["ALXD"] = "暗老小对"; 
