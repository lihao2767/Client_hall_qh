...
cc.Class({
	...
	ShowOtherScore: function(ShowNode, huInfo) {
        ...
        ShowNode.getChildByName('gangfenLb').getComponent("cc.Label").string = "杠分" + this.ToUiScore(gangPoint);
    },
	...
	IsShowMulti2: function (huType) {
		let multi2 = ["AnGang", "JieGang", "Gang", "ZiMo", "DuanDui"];
		let isShow = multi2.indexOf(huType) != -1;
		return isShow;
	},
	LabelName: function (huType) {
		...
		huTypeDict["HeJueZhang"]="绝张";
		huTypeDict["PPH"]="对对胡";
		huTypeDict["QuanDa"]="全老";
		huTypeDict["DaYuWu"]="十老";
		huTypeDict["QuanXiao"]="全小";
		huTypeDict["XiaoYuWu"]="十小";
		huTypeDict["CCHDDHu"]="十通";
		huTypeDict["CHDDHu"]="九通";
		huTypeDict["HDDHu"]="八通";
		huTypeDict["QDHu"]="七通";
		huTypeDict["LianLiu"]="六通";
		huTypeDict["WuFanHe"]="五通";
		huTypeDict["PengBanZi"]="对子";
		huTypeDict["DuanDui"]="对子";
		huTypeDict["AnKe"]="暗刻";
		huTypeDict["SiGuiYi"]="四核";
		huTypeDict["QYS"]="清一色";
		huTypeDict["HYS"]="混一色";
		huTypeDict["QueYiSe"]="缺一门";
		huTypeDict["SYZhi"]="十一支";
		huTypeDict["ShuangYou"]="双八支";
		huTypeDict["QYSYTL"]="顶九卡五";
		huTypeDict["Long"]="顶九";
		huTypeDict["DanYou"]="八支";
		huTypeDict["MenQing"]="万事";
