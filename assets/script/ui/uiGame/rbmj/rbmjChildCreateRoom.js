...
var rbmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		let sendPack = {};
		let hongbaopai = this.GetIdxByKey('hongbaopai');
		let chushidianshu = this.GetIdxByKey('chushidianshu');
		...
		sendPack = {
			"hongbaopai": hongbaopai,
			"chushidianshu": chushidianshu,
...
module.exports = rbmjChildCreateRoom;