...
var jsnyzmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		...
		let dingfen = this.GetIdxByKey('dingfen');
	...
	OnToggleClick: function (event) {
		...
		if ('renshu' == key) {
			if (toggleIndex == 0) {
				this.Toggles['moshi'][3].getChildByName("label").color = cc.color(158, 49, 16);
				...
				if (this.Toggles["moshi"][3].getChildByName("checkmark").active) {
					...
					this.Toggles['moshi'][0].getChildByName("label").color = this.RedColor1;
				}
				this.Toggles["moshi"][3].getChildByName("checkmark").active = false;
				this.Toggles['moshi'][3].getChildByName("label").color = cc.color(180, 180, 180);
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			// 	“十三幺”和“去筒”只能二选一；
			// if (this.Toggles['kexuanwanfa'][2].getChildByName('checkmark').active && toggleIndex == 8) {
			// 	this.Toggles['kexuanwanfa'][2].getChildByName('checkmark').active = false;
			// 	this.UpdateLabelColor(this.Toggles['kexuanwanfa'][2].parent);
			// } else if (this.Toggles['kexuanwanfa'][8].getChildByName('checkmark').active && toggleIndex == 2) {
	...
	UpdateOnClickToggle: function (key, toggleIndex) {
		...
		if (this.Toggles["renshu"] && this.Toggles["moshi"] && this.Toggles["kexuanwanfa"]) {
