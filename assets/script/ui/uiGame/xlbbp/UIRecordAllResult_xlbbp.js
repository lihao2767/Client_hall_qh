...
cc.Class({
    ...
    OnCreateInit: function () {
        ...
        //加载麻将资源，防止异步坑爹的bug
        // this.LoadAllImages();
		this.RegEvent("xlbbp_ChangeSelectState", this.Event_ChangeSelectState, this);
    },
	...
	ShowAllWater: function (pos) {
		let waters = this.posResultList[pos].winDetail;

		this.waterContents.removeAllChildren();
		for (let idx = 0; idx < waters.length; idx++) {
			let waterInfo = waters[idx];
			let waterNode = cc.instantiate(this.waterItem);
			this.waterContents.addChild(waterNode);
			waterNode.getChildByName("lb_pos").getComponent(cc.Label).string = waterInfo.winPosID + 1;

			let huTypes = [];
			let huTypeDict = this.GetHuTypeDict();
			for (let idx = 0; idx < waterInfo.opPointList.length; idx++) {
				let huType = waterInfo.opPointList[idx];
			...
			waterNode.getChildByName("lb_huType").getComponent(cc.Label).string = huTypes.join("、");
			waterNode.getChildByName("lb_double").getComponent(cc.Label).string = waterInfo.allBei + "倍";
			...
			waterNode.getChildByName("lb_huType").color = color;
			waterNode.getChildByName("lb_double").color = color;
			waterNode.getChildByName("lb_score").color = color;
		}
	},
	...
	GetHuTypeDict: function () {
		...
		huTypeDict["TH"] = "同花";
		huTypeDict["ZS"] = "杂色";
		huTypeDict["BBLLT"] = "八宝琉璃塔";
		huTypeDict["BBXL"] = "八宝显灵";
		huTypeDict["SWXH"] = "四王相会";
		huTypeDict["YHJT"] = "银河九天";
		huTypeDict["JLFW"] = "金轮法王";
		huTypeDict["MYTX"] = "母仪天下";
		huTypeDict["QFGJ"] = "千帆过尽";
		huTypeDict["QSZT"] = "雀上枝头";
		huTypeDict["SNJW"] = "十拿九稳";
		huTypeDict["LFLZ"] = "龙凤连炸";
		huTypeDict["EBFH"] = "二八芳华";
		huTypeDict["SZD"] = "双炸弹";
		huTypeDict["SDED"] = "四带二对";
		huTypeDict["SWSKDYD"] = "双510K带一对";
		huTypeDict["FJDYD"] = "飞机带一对";
		huTypeDict["SSTDYD"] = "双三条带一对";
		huTypeDict["LD"] = "连队";
		huTypeDict["BSZ"] = "八顺子";
		huTypeDict["THTS"] = "同花天顺";
		huTypeDict["BXDS"] = "八星";
		huTypeDict["HEYSN"] = "花儿与少年";
		huTypeDict["DLGGG"] = "灯笼高高挂";
		huTypeDict["CFTL"] = "春风桃李";
		huTypeDict["DNSWF"] = "东南四五峰";
		huTypeDict["LXDS"] = "六星带对子";
		huTypeDict["WXDS"] = "五星带三张";
		huTypeDict["WSZDSZ"] = "五顺带三张";
		huTypeDict["WSDWSK"] = "五星带wsk";
		huTypeDict["ELZ"] = "二连炸";
    ...
    ShowData: function () {
		...
		app.Client.OnEvent("xlbbp_ChangeSelectState", this.posResultList[0].pos);
