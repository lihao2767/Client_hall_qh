...
cc.Class({
    ...
    UpdatePlayData: function (PlayerNode, HuList, PlayerInfo, jin1 = 0, jin2 = 0, maiMaList = []) {
        ...
        this.ShowPlayerNiaoPai(PlayerNode.getChildByName('zhongma'), maiMaList, HuList.zhongList, HuList.huType);
    },
    ...
    GetHuTypeDict: function () {
        ...
        huTypeDict["HYS"]="混一色";
        huTypeDict["PPHu"]="碰碰胡";
        huTypeDict["HYSDDP"]="混一色碰碰胡";
        huTypeDict["QYSPPH"]="清一色碰碰胡";
        huTypeDict["DianPao"]="点炮";
        huTypeDict["Zhuang"]="跟庄";
        huTypeDict["ShouZhuaYi"]="手把一";
        huTypeDict["SSY"]="十三幺";
        huTypeDict["BaoHu"]="包胡";
        huTypeDict["MaiMa"]="马分";
        huTypeDict["MenFeng"]="门风刻";
        huTypeDict["QuanFeng"]="风圈刻";
        huTypeDict["Zhong"]="红中刻";
        huTypeDict["FaCaiGang"]="发财刻";
        huTypeDict["BaiBan"]="白板刻";
        huTypeDict["JiuPengBaoDeng"]="九蓬宝灯";
        huTypeDict["ZYS"]="字一色";
        huTypeDict["DaSanYuan"]="大三元";
        huTypeDict["XiaoSanYuan"]="小三元";
        huTypeDict["DaSiXi"]="大四喜";
        huTypeDict["XiaoSiXi"]="小四喜";
        huTypeDict["HunYaoJiu"]="混幺九";
        huTypeDict["QingYaoJiu"]="清幺九";
