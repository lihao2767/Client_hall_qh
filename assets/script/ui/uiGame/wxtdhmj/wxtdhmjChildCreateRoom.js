...
var thgjmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        ...
        let gudingpiao=-1;
        if (piaofen == 1) {
            gudingpiao=this.GetIdxByKey('gudingpiao');
        }
    ...
    UpdateOnClickToggle: function () {
        if(this.Toggles["gudingpiao"]){
            this.UpdateLabelColor(this.Toggles['gudingpiao'][0].parent);
            if(!this.Toggles["piaofen"][1].getChildByName("checkmark").active){
                this.Toggles['gudingpiao'][0].getChildByName("checkmark").active = false;
                //置灰
                if(this.Toggles['gudingpiao'][0].getChildByName("label")){
                    this.Toggles['gudingpiao'][0].getChildByName("label").color = cc.color(180, 180, 180);
                }
                this.Toggles['gudingpiao'][1].getChildByName("checkmark").active = false;
                //置灰
                if(this.Toggles['gudingpiao'][1].getChildByName("label")){
                    this.Toggles['gudingpiao'][1].getChildByName("label").color = cc.color(180, 180, 180);
                }
                this.Toggles['gudingpiao'][2].getChildByName("checkmark").active = false;
                //置灰
                if(this.Toggles['gudingpiao'][2].getChildByName("label")){
                    this.Toggles['gudingpiao'][2].getChildByName("label").color = cc.color(180, 180, 180);
                }
            }else{
                //恢复
                if(this.Toggles['gudingpiao'][0].getChildByName("label")){
                    this.Toggles['gudingpiao'][0].getChildByName("label").color = cc.color(158, 49, 16);
                }
                if(this.Toggles['gudingpiao'][1].getChildByName("label")){
                    this.Toggles['gudingpiao'][1].getChildByName("label").color = cc.color(158, 49, 16);
                }
                if(this.Toggles['gudingpiao'][2].getChildByName("label")){
                    this.Toggles['gudingpiao'][2].getChildByName("label").color = cc.color(158, 49, 16);
                }
            }
        }
    },
