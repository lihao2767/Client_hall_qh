...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        let other510KStr = "";
        if(player.other510KPoint != 0){
            other510KStr = "(" + player.other510KPoint + ")"
        }
        ...
        scoreDetails.getChildByName("lb_count510KPoint").getComponent(cc.Label).string = player.count510KPoint > 0 ? "+" + player.count510KPoint + other510KStr : player.count510KPoint + other510KStr;
