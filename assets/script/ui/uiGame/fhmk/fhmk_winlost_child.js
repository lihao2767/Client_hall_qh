...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        scoreDetails.getChildByName("lb_prizePoint").getComponent(cc.Label).string = player.daoShuPoint > 0 ? "+" + player.daoShuPoint : player.daoShuPoint;
        scoreDetails.getChildByName("lb_count510KPoint").getComponent(cc.Label).string = player.k510Point > 0 ? "+" + player.k510Point : player.k510Point;
