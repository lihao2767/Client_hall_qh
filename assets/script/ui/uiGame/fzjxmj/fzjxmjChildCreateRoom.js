...
var gamjChildCreateRoom = cc.Class({
    ...
    UpdateOnClickToggle: function (key, toggleIndex) {
        if (!key || ("renshu" == key) || "maima" == key && (toggleIndex == 0)) {
            if (this.Toggles["renshu"] && this.Toggles["maima"]) {

                if (this.Toggles["renshu"][1].getChildByName("checkmark").active ||
                    this.Toggles["renshu"][2].getChildByName("checkmark").active) {
                    // 置灰
                    // if (!!key) {
                    // 	this.Toggles['maima'][1].getChildByName("checkmark").isSelected = this.Toggles['maima'][1].getChildByName("checkmark").active;
                    // 	this.Toggles['maima'][2].getChildByName("checkmark").isSelected = this.Toggles['maima'][2].getChildByName("checkmark").active;
                    // 	this.Toggles['maima'][3].getChildByName("checkmark").isSelected = this.Toggles['maima'][3].getChildByName("checkmark").active;
                    // 	this.Toggles['maima'][4].getChildByName("checkmark").isSelected = this.Toggles['maima'][4].getChildByName("checkmark").active;
                    // 	this.Toggles['maima'][5].getChildByName("checkmark").isSelected = this.Toggles['maima'][4].getChildByName("checkmark").active;
                    // }

                    this.Toggles['maima'][0].getChildByName("checkmark").active = true;
                    this.Toggles['maima'][1].getChildByName("checkmark").active = false;
                    this.Toggles['maima'][2].getChildByName("checkmark").active = false;
                    this.Toggles['maima'][3].getChildByName("checkmark").active = false;
                    this.Toggles['maima'][4].getChildByName("checkmark").active = false;
                    this.Toggles['maima'][5].getChildByName("checkmark").active = false;

                    this.Toggles['maima'][1].getChildByName("label").color = cc.color(180, 180, 180);
                    this.Toggles['maima'][2].getChildByName("label").color = cc.color(180, 180, 180);
                    this.Toggles['maima'][3].getChildByName("label").color = cc.color(180, 180, 180);
                    this.Toggles['maima'][4].getChildByName("label").color = cc.color(180, 180, 180);
                    this.Toggles['maima'][5].getChildByName("label").color = cc.color(180, 180, 180);

                } else {
                    // 恢复
                    // if (!!key) {
                    // 	this.Toggles['maima'][1].getChildByName("checkmark").active = this.Toggles['maima'][1].getChildByName("checkmark").isSelected;
                    // 	this.Toggles['maima'][2].getChildByName("checkmark").active = this.Toggles['maima'][2].getChildByName("checkmark").isSelected;
                    // 	this.Toggles['maima'][3].getChildByName("checkmark").active = this.Toggles['maima'][3].getChildByName("checkmark").isSelected;
                    // 	this.Toggles['maima'][4].getChildByName("checkmark").active = this.Toggles['maima'][4].getChildByName("checkmark").isSelected;
                    // 	this.Toggles['maima'][5].getChildByName("checkmark").active = this.Toggles['maima'][4].getChildByName("checkmark").isSelected;
                    // }

                    this.Toggles['maima'][1].getChildByName("label").color = cc.color(158, 49, 16);
                    this.Toggles['maima'][2].getChildByName("label").color = cc.color(158, 49, 16);
                    this.Toggles['maima'][3].getChildByName("label").color = cc.color(158, 49, 16);
                    this.Toggles['maima'][4].getChildByName("label").color = cc.color(158, 49, 16);
                    this.Toggles['maima'][5].getChildByName("label").color = cc.color(158, 49, 16);
                }
            }
        }
    },
