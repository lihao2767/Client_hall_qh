...
cc.Class({
    ...
    ShowPlayerData:function(setEnd,playerAll,index){
        ...
        let huPoint = posResultList[index]["huPoint"];
        huPoint = huPoint> 0 ? "+"+huPoint : huPoint;
        let huaPoint = posResultList[index]["huaPoint"];
        huaPoint = huaPoint> 0 ? "+"+huaPoint : huaPoint;
        let gangPoint = posResultList[index]["gangPoint"];
        gangPoint = gangPoint> 0 ? "+"+gangPoint : gangPoint;
        this.node.getChildByName("jiesuan").getChildByName("otherscore").getChildByName("huPointlb").getComponent(cc.Label).string = "胡分" + huPoint;
        this.node.getChildByName("jiesuan").getChildByName("otherscore").getChildByName("huaPointlb").getComponent(cc.Label).string = "花分" + huaPoint;
        this.node.getChildByName("jiesuan").getChildByName("otherscore").getChildByName("gangPointlb").getComponent(cc.Label).string = "杠分" + gangPoint;
    },
