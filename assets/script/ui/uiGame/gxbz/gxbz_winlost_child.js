...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        scoreNodes.getChildByName('lb_winLosePoint').getComponent(cc.Label).string = player.winLosePoint > 0 ? "+" + player.winLosePoint : player.winLosePoint;
        scoreNodes.getChildByName('lb_jianfen').getComponent(cc.Label).string = player.k510Point > 0 ? "+" + player.k510Point : player.k510Point;
        scoreNodes.getChildByName('lb_jiangfen').getComponent(cc.Label).string = player.bombPoint > 0 ? "+" + player.bombPoint : player.bombPoint;
        // scoreNodes.getChildByName('lb_jianfen').getComponent(cc.Label).string = lb_jianfen;

        // fennode.getChildByName('lb_jianfen').getComponent(cc.Label).string = "捡分:" + posResultInfo.k510Point;
		// fennode.getChildByName('lb_jiangfen').getComponent(cc.Label).string = "奖分:" + posResultInfo.bombPoint;
		// fennode.getChildByName('lb_shuying').getComponent(cc.Label).string = "输赢分:" + posResultInfo.winLosePoint;
		// fennode.getChildByName('lb_roompoint').getComponent(cc.Label).string = "房间总分:" + posResultInfo.roomPoint;
