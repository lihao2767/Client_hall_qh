...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        this.node.getChildByName('record').getChildByName('lb_shouCardSize').getComponent(cc.Label).string = "" + posEndList.maFen;
        this.node.getChildByName('record').getChildByName('lb_loseSize').getComponent(cc.Label).string = "" + posEndList.shuYingFen;
        this.node.getChildByName('record').getChildByName('lb_shuying').getComponent(cc.Label).string = "" + posEndList.point;
        this.node.getChildByName('record').getChildByName('lb_roompoint').getComponent(cc.Label).string = "" + posEndList.roomPoint;
        let maiMaDict = {
            "-1": "",
            0: "",
            1: "买1码",
        ...
        this.node.getChildByName('record').getChildByName('lb_maima').getComponent(cc.Label).string = "" + maiMaDict[posEndList.buyMa];
        this.node.getChildByName('record').getChildByName('img_huo').active = posEndList.isDPosTeam;
        let youDict = {
            NOT:"",
            ONE:"一游",
            TWO:"二游",
        ...
        this.node.getChildByName('record').getChildByName('lb_you').getComponent(cc.Label).string = youDict[posEndList.endType];
