...
cc.Class({
	...
	ShowPlayerRecord: function (ShowNode, huInfo) {
		...
		//显示比赛分
		if (typeof (huInfo.showSportPoint) != "undefined") {
	...
	ShowPlayerJieSuan: function (ShowNode, huInfoAll) {
		console.log("ShowPlayerJieSuan", huInfoAll);
	...
	OnClick: function (btnName, btnNode) {
		...
		console.log(btnNode);
		app.FormManager().ShowForm("ui/uiGame/fkssymj/fkssymjUILiuShui", this.posResultInfo.liuSuiList);
		// }
	},
