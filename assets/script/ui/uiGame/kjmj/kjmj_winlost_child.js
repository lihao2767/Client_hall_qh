...
cc.Class({
	...
	ShowOtherScore: function(ShowNode, huInfo) {
        ...
        ShowNode.getChildByName('jiangmaLb').getComponent("cc.Label").string = "奖码x" + zhongList.length;

        let isShowZhongMaPoint = huInfo["isShowZhongMaPoint"] || false;
		ShowNode.getChildByName('jiangmaLb').active = isShowZhongMaPoint;
    },
