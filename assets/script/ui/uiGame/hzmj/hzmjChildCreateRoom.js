...
var wzmjChildCreateRoom = cc.Class({
    ...
    RefreshAllToggles:function(gameType){
        ...
        if(this.Toggles['yipaoduoxiangzhuaniao']){
    ...
    OnToggleClick:function(event){
        ...
        if('jushu' == key || 'renshu' == key || 'fangfei' == key){
            ...
            return;
             ...
             //七对和七对翻倍
            if (this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active && toggleIndex == 10) {
                this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active = false;
                this.UpdateLabelColor(this.Toggles['kexuanwanfa'][0].parent);
            } else if (this.Toggles['kexuanwanfa'][10].getChildByName('checkmark').active && toggleIndex == 0) {
