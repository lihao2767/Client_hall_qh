...
var jsnyzmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		let sendPack = {};
		let daizhuang = this.GetIdxByKey('daizhuang');
		...
		let paixingjiafan = this.GetIdxsByKey('paixingjiafan');
	...
	UpdateOnClickToggle: function (key, toggleIndex) {
		...
		if (this.Toggles["haozi"] && this.Toggles["kexuanwanfa"]) {
			if (this.Toggles["haozi"][1].getChildByName("checkmark").active ||
				this.Toggles["kexuanwanfa"][0].getChildByName("checkmark").active) {
		...
		if (this.Toggles["daizhuang"] && this.Toggles["kexuanwanfa"]) {
			if (this.Toggles["daizhuang"][0].getChildByName("checkmark").active) {
