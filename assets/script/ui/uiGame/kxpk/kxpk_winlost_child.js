...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        let strMoGivePoint = (player.moGivePoint > 0 ? "+" : "") + player.moGivePoint;
        ...
        scoreNodes.getChildByName('lb_k510Point').getComponent(cc.Label).string = (player.count510KPoint > 0 ? "+" + player.count510KPoint : player.count510KPoint) + "(" + strMoGivePoint + ")";;
