...
var hspdkChildCreateRoom = cc.Class({
    ...
    OnToggleClick:function(event){
        ...
        if('jushu' == key || 'renshu' == key || 'fangfei' == key){      
            ...
            if('renshu' == key){
                if(1 == toggleIndex){
                    this.Toggles['kexuanwanfa'][17].getChildByName('checkmark').active = false;
                    this.UpdateLabelColor(this.Toggles['kexuanwanfa'][17].parent);
                }
            }
            return;
        }
            ...
            if (toggleIndex == 17) {
                if(this.Toggles['renshu'][0].getChildByName('checkmark').active==false){
                    app.SysNotifyManager().ShowSysMsg("2人才能选择抢庄玩法");
                    return;
                }
            }
        }
            ...
            if(this.gameType == this.gameCreateConfig[key].GameName){
                if(curKey == this.gameCreateConfig[key].Key){
                    ...
                    if("kexuanwanfa" == curKey){
                        ...
                        this.Toggles['kexuanwanfa'][16].serverIdx = 33;//反春天
                        this.Toggles['kexuanwanfa'][17].serverIdx = 34;//抢庄
...
module.exports = hspdkChildCreateRoom;