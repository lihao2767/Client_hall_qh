...
cc.Class({
	...
	OnCreateInit: function () {
		...
		for (let i = 1; i <= this.ShareDefine['XGCGMJRoomDealPerPosCardCount']; i++) {
			let cardNode = cc.instantiate(sp_in);
			cardNode.name = this.ComTool.StringAddNumSuffix("card", Math.abs(i - (this.ShareDefine['XGCGMJRoomDealPerPosCardCount'] + 1)), 2);
