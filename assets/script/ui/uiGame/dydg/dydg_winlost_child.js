...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        let shuYingPoint = player.shuYingPoint;
        if (shuYingPoint > 0) {
            winNode.active = true;
            winNode.getComponent(cc.Label).string = "+" + shuYingPoint;
            ...
            loseNode.getComponent(cc.Label).string = shuYingPoint;
        ...
        scoreNodes.getChildByName('lb_jiangfen').getComponent(cc.Label).string = player.jiangPoint > 0 ? "+" + player.jiangPoint : player.jiangPoint;
