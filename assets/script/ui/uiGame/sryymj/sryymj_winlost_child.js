...
cc.Class({
    ...
    UpdatePlayData: function (PlayerNode, HuList, PlayerInfo, jin1 = 0, jin2 = 0, maiMaList = []) {
        ...
        this.ShowPlayerNiaoPai(PlayerNode.getChildByName('sv_zhongma').getChildByName('view').getChildByName('zhongma'), maiMaList, HuList.zhongList, HuList.huType);
    },
    ...
    ShowPlayerNiaoPai: function (ShowNode, maiMaList, zhongList, huType) {
    ...
    GetHuTypeDict: function () {
        ...
        huTypeDict["SSY"]="十三幺";
        huTypeDict["QXSSY"]="七星十三幺";
        huTypeDict["QXSSY8"]="七星十三幺";
        huTypeDict["JiuYao"]="九幺";
        huTypeDict["HaoHuaJiuYao"]="豪华九幺";
        huTypeDict["QiXingJiuYao"]="七星九幺";
        huTypeDict["HaoHuaQiXingJiuYao"]="豪华七星九幺";
        huTypeDict["TianHu"]="天胡";
        huTypeDict["DanDiao"]="单吊";
        huTypeDict["DaoDiao1"]="宝吊";
        huTypeDict["DaoDiao2"]="宝吊";
        huTypeDict["DaoHuanYuan"]="宝还原";
        huTypeDict["DiHu"]="地胡";
        huTypeDict["QYS"]="清一色";
        huTypeDict["GSKH"]="杠上开花";
        huTypeDict["QiangGangHu"]="抢杠胡";
        huTypeDict["AnGangPoint"]="暗杠";
        huTypeDict["MingGangPoint"]="明杠";
        huTypeDict["ZiMo"]="自摸";
        huTypeDict["FeiBao"]="飞宝分";
        huTypeDict["SiBao"]="四宝分";
