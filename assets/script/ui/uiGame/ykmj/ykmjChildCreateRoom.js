        ...
        if(this.Toggles["kexuanwanfa"]){
            ...
            if(!this.Toggles["kexuanwanfa"][0].getChildByName("checkmark").active){
                ...
                if(this.Toggles['kexuanwanfa'][2].getChildByName("label")){
                    ...
                    let isChecked = this.Toggles['kexuanwanfa'][2].getChildByName('checkmark').active;
                    if (isChecked) {
                        this.Toggles['kexuanwanfa'][2].getChildByName("label").color = this.RedColor1;
                    }
                    else {
                        this.Toggles['kexuanwanfa'][2].getChildByName("label").color = this.RedColor2;
                    }
                }
                //恢复
                if(this.Toggles['kexuanwanfa'][10].getChildByName("label")){
                    // this.Toggles['kexuanwanfa'][10].getChildByName("label").color = cc.color(158, 49, 16);
                    let isChecked = this.Toggles['kexuanwanfa'][10].getChildByName('checkmark').active;
                    if (isChecked) {
                        this.Toggles['kexuanwanfa'][10].getChildByName("label").color = this.RedColor1;
                    }
                    else {
                        this.Toggles['kexuanwanfa'][10].getChildByName("label").color = this.RedColor2;
                    }
                }
                //恢复
                if(this.Toggles['kexuanwanfa'][11].getChildByName("label")){
                    // this.Toggles['kexuanwanfa'][11].getChildByName("label").color = cc.color(158, 49, 16);
                    let isChecked = this.Toggles['kexuanwanfa'][11].getChildByName('checkmark').active;
                    if (isChecked) {
                        this.Toggles['kexuanwanfa'][11].getChildByName("label").color = this.RedColor1;
                    }
                    else {
                        this.Toggles['kexuanwanfa'][11].getChildByName("label").color = this.RedColor2;
                    }
                }
            }
            //不勾选“有追风杠”，“追风杠可碰”要置灰不能勾选；
            if(!this.Toggles["kexuanwanfa"][4].getChildByName("checkmark").active){
                ...
                if(this.Toggles['kexuanwanfa'][5].getChildByName("label")){
                    ...
                    let isChecked = this.Toggles['kexuanwanfa'][5].getChildByName('checkmark').active;
                    if (isChecked) {
                        this.Toggles['kexuanwanfa'][5].getChildByName("label").color = this.RedColor1;
                    }
                    else {
                        this.Toggles['kexuanwanfa'][5].getChildByName("label").color = this.RedColor2;
                    }
                }
            }
        }
