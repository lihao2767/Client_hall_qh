...
var thgjmjChildCreateRoom = cc.Class({
    ...
    OnToggleClick:function(event){
        ...
        if('jushu' == key || 'renshu' == key || 'fangfei' == key){
            ...
            if(toggleIndex == 0 && this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active==true){
                if(this.Toggles['kexuanwanfa'][3].getChildByName('checkmark').active==true){
                    app.SysNotifyManager().ShowSysMsg("改变听口不可开杠必须勾选报听玩法",[],3);
                    return;
                }
            }
        }
