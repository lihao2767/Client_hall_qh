...
var jsnyzmjChildCreateRoom = cc.Class({
	...
	AdjustSendPack: function (sendPack) {
		// if (sendPack.maima == 0 || sendPack.maima == 3) {
		// 	sendPack.mashu = -1;
		// 	sendPack.kaimawanfa = [];
		// }
		return sendPack;
	...
	OnToggleClick: function (event) {
		...
		// }
		// else if ('maima' == key) {
		// 	if (toggleIndex == 0 || toggleIndex == 3) {
		// 		this.Toggles['mashu'][0].parent.active = false;
		// 		this.Toggles['kaimawanfa'][0].parent.active = false;
		// 	} else {
		// 		this.Toggles['mashu'][0].parent.active = true;
		// 		this.Toggles['kaimawanfa'][0].parent.active = true;
		// 	}
		// }
		// else if ('jiangma' == key) {
		...
		// }
			...
			// 	“忍炮”和“不可过胡”，选了一个另外一个就不可选，阴影置灰；
			if (this.Toggles['kexuanwanfa'][3].getChildByName('checkmark').active && toggleIndex == 2) {
				this.Toggles['kexuanwanfa'][3].getChildByName('checkmark').active = false;
				this.UpdateLabelColor(this.Toggles['kexuanwanfa'][3].parent);
			} else if (this.Toggles['kexuanwanfa'][2].getChildByName('checkmark').active && toggleIndex == 3) {
			...
			// "ToggleDesc": "同IP不可进,100米内不可进,禁止使用道具,200米内不可进,30秒未准备自动踢出房间,禁止语音,禁止文字,5秒未准备自动踢出房间",
	...
	UpdateOnClickToggle: function (key, toggleIndex) {
		if (this.Toggles["xiaojuqiepai"]) {
			if (this.unionData && this.unionData.clubId > 0) {
				this.Toggles["xiaojuqiepai"][0].parent.active = true;
			} else {
				this.Toggles["xiaojuqiepai"][0].parent.active = false;
			}
		}
		
		// 	没有勾选“忍炮”，“报叫过胡可接炮”阴影置灰不可选；
		if (this.Toggles["kexuanwanfa"]) {
			if (this.Toggles["kexuanwanfa"][3].getChildByName("checkmark").active) {
				if (this.Toggles["kexuanwanfa"][4].getChildByName("checkmark").active) {
					this.Toggles['kexuanwanfa'][4].getChildByName("label").color = cc.color(0, 155, 46);
				} else {
		...
		// if (this.Toggles["maima"] && this.Toggles["mashu"]) {
		...
		// if (this.Toggles["mashu"] && this.Toggles["kaimawanfa"]) {
		// 	if (this.Toggles["maima"][0].getChildByName("checkmark").active || this.Toggles["maima"][3].getChildByName("checkmark").active) {
		// 		this.Toggles['mashu'][0].parent.active = false;
		// 		this.Toggles['kaimawanfa'][0].parent.active = false;
		// 	} else {
		// 		this.Toggles['mashu'][0].parent.active = true;
