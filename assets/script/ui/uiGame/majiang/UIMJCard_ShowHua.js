...
cc.Class({
    ...
    //多花用参数传花数，默认8花
    ShowHuaListByHGXSMJ: function (cardIDList, jin1 = 0, jin2 = 0, jinJin = 0, imageString = 'EatCard_Self_') {
        this.ChildCount = 12;
        let count = 0;
        if (typeof (cardIDList) != "undefined") {
            count = cardIDList.length;
    ...
    //多花用参数传花数，默认8花
    ShowHuaListByHSHHMJ: function (cardIDList, jin1 = 0, jin2 = 0, imageString = 'EatCard_Self_') {
        this.ChildCount = 12;
        let count = 0;
        if (typeof (cardIDList) != "undefined") {
            count = cardIDList.length;
