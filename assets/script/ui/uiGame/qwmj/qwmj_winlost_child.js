...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        this.UpdatePlayData(this.node, posResultList[index], PlayerInfo, jin1, jin2, jinJin);
    ...
    UpdatePlayData: function (PlayerNode, HuList, PlayerInfo, jin1 = 0, jin2 = 0, jinJin = 0,zhuaNiaoList = null) {
        this.showLabelNum = 1;
    ...
    LabelName: function (huType) {
        ...
        huTypeDict["DiHu"]="地胡";
        huTypeDict["SiGuiYi"]="带跟";
        huTypeDict["WuJi"]="无鸡";
        huTypeDict["QingDui"]="清对";
        huTypeDict["AnGang"]="暗杠";
        huTypeDict["Gang"]="补杠";
        huTypeDict["JieGang"]="点杠";
        huTypeDict["RuanAnGang"]="软暗杠";
        huTypeDict["RuanGang"]="软补杠";
        huTypeDict["RuanJieGang"]="软直杠";
    ...
    IsShowMulti2: function (huType) {
        let multi2 = ["AnGang", "Gang", "JieGang", "RuanAnGang", "RuanGang", "RuanJieGang", "ChaJiao"];
        let isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    ...
    ShowPlayerShowCard: function (ShowNode, cardIDList, handCard, jin1, jin2, jinJin) {
        ...
        UICard_ShowCard.ShowDownCardByYBXZMJ(cardIDList, handCard, jin1, jin2, jinJin);
    },
    ShowPlayerDownCard: function (ShowNode, publishcard, jin1 = 0, jin2 = 0, jinJin = 0) {
        ...
        UICard_DownCard.ShowDownCardByYBXZMJ(publishcard, jin1, jin2, jinJin);
    },
});
