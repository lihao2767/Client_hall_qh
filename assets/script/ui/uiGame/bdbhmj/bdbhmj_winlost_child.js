...
cc.Class({
    ...
    ShowPlayerNiaoPai: function (ShowNode, maList, zhongList) {
        let zhuaNiaoList = maList;
        let niaoPaiList = zhongList;
        for (let i = 1; i <= 20; i++) {
    ...
    ShowPlayerJieSuan: function (ShowNode, huInfoAll) {
        ...
        for (let huType in huInfo) {
            ...
            if (["GF", "MF", "HPF"].indexOf(huType) > -1) {
                let str = (huPoint > 0 ? "+" : "") + huPoint;
                this.ShowLabelName(ShowNode.getChildByName('label_lists'), this.LabelName(huType) + "：" + str);
            } else {
