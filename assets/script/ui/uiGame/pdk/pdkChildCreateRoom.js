...
var pypdkChildCreateRoom = cc.Class({
    ...
    OnToggleClick:function(event){
        ...
        if('jushu' == key || 'renshu' == key || 'fangfei' == key){      
            ...
            } else if (this.Toggles['gaoji'][6].getChildByName('checkmark').active && toggleIndex == 4) {
                this.Toggles['gaoji'][6].getChildByName('checkmark').active = false;
                this.UpdateLabelColor(this.Toggles['gaoji'][6].parent);
            }
        }
        else{
