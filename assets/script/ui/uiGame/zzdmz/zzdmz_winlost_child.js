...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        PlayerNode.getChildByName('lb_chifen').getComponent(cc.Label).string = posEnd.eatPoint;
        PlayerNode.getChildByName('lb_xifen').getComponent(cc.Label).string = posEnd.xiPoint;
        // PlayerNode.getChildByName('lb_touCount').getComponent(cc.Label).string = posEnd.touCount;
        PlayerNode.getChildByName('lb_roompoint').getComponent(cc.Label).string = posEnd.point;
