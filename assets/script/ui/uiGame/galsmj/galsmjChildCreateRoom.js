...
var galsmjChildCreateRoom = cc.Class({
    ...
    AdjustSendPack: function (sendPack) {
        sendPack.kexuanwanfa = sendPack.kexuanwanfa.concat([3, 11]);
        return sendPack;
    },
                        ...
                        if (1 == i) {
                            ...
                            if (AtRows[i - 2] != AtRows[i - 1]) {
                                ...
                                if (dataKey == "kexuanwanfa") {
                                    spacing = [0,0,0,0,0,0,0,150,230,0,0,0,380]
                                }
...
module.exports = galsmjChildCreateRoom;