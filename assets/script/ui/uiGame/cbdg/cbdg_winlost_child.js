...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        scoreNodes.getChildByName('lb_xiFen').getComponent(cc.Label).string = player.xiFen > 0 ? "+" + player.xiFen : player.xiFen;
        scoreNodes.getChildByName('lb_piaoFen').getComponent(cc.Label).string = player.piaoFen > 0 ? "+" + player.piaoFen : player.piaoFen;
        scoreNodes.getChildByName('lb_k510Point').getComponent(cc.Label).string = player.k510Point > 0 ? "+" + player.k510Point : player.k510Point;
		...
		scoreNodes.getChildByName('lb_tuoGuanShuFen').getComponent(cc.Label).string = player.tuoGuanShuFen > 0 ? "+" + player.tuoGuanShuFen : player.tuoGuanShuFen;
