...
var sjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		...
		let tuoguanshufenfenzhi = this.GetEditBoxByKey('tuoguanshufenfenzhi');
		...
		if (kexuanwanfa.indexOf(3) > -1 && !this.CheckEditBoxData("tuoguanshufenfenzhi")) {
			return null;
		}
		...
		sendPack = {
			...
			"piaofen": piaofen,
			"tuoguanshufenfenzhi": tuoguanshufenfenzhi,
	...
	AdjustSendPack: function (sendPack) {
		if (sendPack.kexuanwanfa.indexOf(3) == -1) {
			sendPack.tuoguanshufenfenzhi = -1;
		}
		return sendPack;
	},
	...
	OnToggleClick: function (event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			if (key == "renshu") {
				if (toggleIndex == 2) {
					...
					this.Toggles['tuoguanshufenfenzhi'][0].parent.active = true;
					...
					this.Toggles['tuoguanshufenfenzhi'][0].parent.active = false;
		...
		// }
			...
			// if (toggleIndex == 5 && this.Toggles["kexuanwanfa"][3].getChildByName('checkmark').active) {
			// 	this.Toggles["kexuanwanfa"][3].getChildByName('checkmark').active = false;
			// 	this.UpdateLabelColor(this.Toggles["kexuanwanfa"][3].parent);
			// } else if (toggleIndex == 4 && this.Toggles['kexuanwanfa'][5].getChildByName('checkmark').active) {
	...
	UpdateOnClickToggle: function (key, toggleIndex) {
		...
		if (this.Toggles['tuoguanshufenfenzhi'] && this.Toggles['kexuanwanfa']) {
			if (this.Toggles["kexuanwanfa"][3].active && this.Toggles["kexuanwanfa"][3].getChildByName('checkmark').active) {
				this.Toggles['tuoguanshufenfenzhi'][0].parent.active = true;
			} else {
				this.Toggles['tuoguanshufenfenzhi'][0].parent.active = false;
			}
	...
	OnUpdateTogglesLabel: function (TogglesNode) {
		...
		// 	二三人场隐藏摇摆,炸错罚分,额外加分。
		if (this.Toggles["kexuanwanfa"] && this.Toggles['tuoguanshufenfenzhi']) {
			if (this.Toggles["renshu"][2].getChildByName("checkmark").active) { // 四人
				this.Toggles["kexuanwanfa"][0].active = true;
				this.Toggles["kexuanwanfa"][1].active = true;
				this.Toggles["kexuanwanfa"][2].active = true;
