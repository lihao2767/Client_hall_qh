...
cc.Class({
    ...
    UpdatePlayData: function (PlayerNode, HuList, PlayerInfo, jin1 = 0, jin2 = 0, zhuaNiaoList = null) {
        ...
        this.ShowPlayerShowCard(PlayerNode.getChildByName('showcard'), HuList.shouCard, HuList.handCard, jin1, jin2, HuList.gangMap);
    ...
    ShowPlayerDownCard: function (ShowNode, publishcard, jin1 = 0, jin2 = 0, gangMap) {
        ShowNode.active = 1;
        let UICard_DownCard = ShowNode.getComponent("UIMJCard_Down");
        UICard_DownCard.ShowDownCardToGangMap(publishcard, "EatCard_Self_", gangMap);
    },
});
