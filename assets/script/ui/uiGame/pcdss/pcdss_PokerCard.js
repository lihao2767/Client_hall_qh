...
var PCDSSPokerCard = app.BaseClass.extend({
	...
	LoadAllPokerRes: function () {
		...
		cc.loader.loadResDir("ui/uiGame/pcdss/poker/selfout", cc.SpriteFrame, function (err, assets) {
			if (err) {
				cc.error(err);
				return;
			}
...
exports.GetModel = function () {
	if (!g_PCDSSPokerCard) {
		g_PCDSSPokerCard = new PCDSSPokerCard();
	}
	return g_PCDSSPokerCard;
};