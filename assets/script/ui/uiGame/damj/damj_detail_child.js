...
cc.Class({
	...
	huTypesShow:function(jiesuan,huData){
        ...
        jiesuan.getChildByName('top').getChildByName('lb_angang').getComponent(cc.Label).string=huData.anGangPoint;
       	jiesuan.getChildByName('top').getChildByName('lb_minggang').getComponent(cc.Label).string=huData.jieGangPoint;
        jiesuan.getChildByName('top').getChildByName('lb_bugang').getComponent(cc.Label).string=huData.gangPoint;
    },
});
