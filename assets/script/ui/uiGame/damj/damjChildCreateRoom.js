...
var hzzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        ...
        let jiamai=this.GetIdxByKey('jiamai');
        let mayou=this.GetIdxByKey('mayou');
    ...
    UpdateOnClickToggle: function() {
        //选项置灰
        if(this.Toggles["koupai"]){
            this.UpdateLabelColor(this.Toggles['koupai'][0].parent);
            if(!this.Toggles["koupai"][0].getChildByName("checkmark").active){
                this.Toggles['koupai'][1].getChildByName("checkmark").active = false;
                this.Toggles['koupai'][2].getChildByName("checkmark").active = false;
                //置灰
                if(this.Toggles['koupai'][1].getChildByName("label")){
                    this.Toggles['koupai'][1].getChildByName("label").color = cc.color(180, 180, 180);
                }
                if(this.Toggles['koupai'][2].getChildByName("label")){
                    this.Toggles['koupai'][2].getChildByName("label").color = cc.color(180, 180, 180);
                }
            }else{
                //恢复
                if(this.Toggles['koupai'][1].getChildByName("label")){
                    this.Toggles['koupai'][1].getChildByName("label").color = cc.color(158, 49, 16);
                }
                if(this.Toggles['koupai'][2].getChildByName("label")){
                    this.Toggles['koupai'][2].getChildByName("label").color = cc.color(158, 49, 16);
                }
            }
        }
