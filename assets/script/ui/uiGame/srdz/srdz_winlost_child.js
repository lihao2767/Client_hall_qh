...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        let biJiang = setEnd.biJiang;

        if(typeof(biJiang)=="undefined"){
            biJiang = false;
        }
        //庄家的队友显示伙
        ...
        scoreDetails.getChildByName("lb_faWangPoint").getComponent(cc.Label).string = player.faWangPoint > 0 ? "+" + player.faPoint : player.faPoint;
