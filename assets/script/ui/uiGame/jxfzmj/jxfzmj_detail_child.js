...
cc.Class({
    ...
    huTypesShow: function (jiesuan, huData) {       
        ...
        if(huData.jieSanFaFen == 0){
            jiesuan.getChildByName('huTypes').getChildByName('fafen').active = false;
        }else{
            jiesuan.getChildByName('huTypes').getChildByName('fafen').active = true;
            jiesuan.getChildByName('huTypes').getChildByName('fafen').getChildByName('num').getComponent(cc.Label).string = huData.jieSanFaFen + '';
        }
    },
});
