...
cc.Class({
    ...
    UpdatePlayData: function (PlayerNode, HuList, PlayerInfo, jin1 = 0, jin2 = 0, zhuaNiaoList = null) {
        ...
        this.ShowPlayerShowCard(PlayerNode.getChildByName('showcard'), HuList.shouCard, HuList.handCard, HuList.langQiCards, jin1, jin2);
    ...
    LabelName: function (huType) {
		...
		huTypeDict["JYSPPH"]="将对";
        huTypeDict["PPH"]="对对胡";
        huTypeDict["HunYaoJiu"]="幺九";
        huTypeDict["QYS"]="清一色";
        huTypeDict["BaoJiao"]="廊起";
        huTypeDict["DianHu"]="廊起放炮";
        huTypeDict["GSKH"]="杠上花";
        huTypeDict["GSP"]="杠上炮";
        ...
        huTypeDict["ShangHuo"]="封顶";
        return huTypeDict[huType];
    },
    IsNotShowScore: function (huType) {
        let multi2 = ["Wan", "Tiao", "Tong", "DiFen", "ZiMoJiaBei", "ShangHuo"];
        let isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    IsShowMulti2: function (huType) {
        let multi2 = ["LQD", "QLQD", "QD", "QQD", "QingD", "QYS", "DDHu", "JGD", "JD", "YJ", "ZZ", "MQ", "TianHu", "DiHu", "GSP", "OGSH", "Gui", "QiangGangHu", "HD"];
        let isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    ...
    ShowPlayerShowCard: function (ShowNode, cardIDList, handCard, liangPaiList = [], jin1, jin2) {
        ShowNode.active = 1;
        let UICard_ShowCard = ShowNode.getComponent("UIMJCard_ShowCard");
        UICard_ShowCard.ShowDownCardByYAXZMJ(cardIDList, handCard, liangPaiList, jin1, jin2);
    },
