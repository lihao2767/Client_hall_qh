...
var sjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        ...
        let feiji=this.GetIdxsByKey('feiji');
        let beishufengding=this.GetIdxByKey('beishufengding');
        let zhadansuanfa=this.GetIdxByKey('zhadansuanfa');
        let jinengpaisuanfa=this.GetIdxByKey('jinengpaisuanfa');
        ...
        sendPack = {
            ...
            "sidai":sidai,
            "feiji":feiji,
            "beishufengding":beishufengding,
            "zhadansuanfa":zhadansuanfa,
            "jinengpaisuanfa":jinengpaisuanfa,
