...
cc.Class({
	...
	ShowOtherScore: function(ShowNode, huInfo) {
        ...
        ShowNode.getChildByName('hupaifenLb').getComponent("cc.Label").string = "胡牌分:" + this.ToUiScore(huPoint);

        let gangPoint = huInfo["gangPoint"] || 0;
        ShowNode.getChildByName('gangfenLb').getComponent("cc.Label").string = "杠    分:" + this.ToUiScore(gangPoint);

        let jiaMaPoint = huInfo["jiaMaPoint"] || 0;
        ShowNode.getChildByName('jiamafenLb').getComponent("cc.Label").string = "加码分:" + this.ToUiScore(jiaMaPoint);

        let jiangMaPoint = huInfo["jiangMaPoint"] || 0;
        ShowNode.getChildByName('jiangmafenLb').getComponent("cc.Label").string = "奖码分:" + this.ToUiScore(jiangMaPoint);
    },
		...
		for (let huType in huInfo) {
			...
			if (this.IsShowMulti2(huType)) {
				...
				// this.ShowLabelName(ShowNode.getChildByName("label_lists"), huTypeDict[huType] + "*2");
					...
					this.ShowLabelName(ShowNode.getChildByName("label_lists"), this.LabelName(huType) + huPoint + "台风");
	...
	IsShowMulti2: function (huType) {
		let multi2 = ["HuPai", "JiaMaPoint", "JiangMaPoint", "GangPoint"];
		let isShow = multi2.indexOf(huType) != -1;
		return isShow;
	},
	LabelName: function (huType) {
		...
		huTypeDict["JXJTF"]="夹心夹";

		huTypeDict["HuPai"]="胡牌";
		huTypeDict["JiaMaPoint"]="加码分";
		huTypeDict["JiangMaPoint"]="奖马分";
