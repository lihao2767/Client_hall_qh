...
var wxmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        ...
        let xianzhi=this.GetIdxByKey('xianzhi');
    ...
    OnToggleClick: function (event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key || 'piaoHua' == key) {
			...
			if(toggleIndex == 3 && !this.Toggles['wanfa'][0].getChildByName('checkmark').active){
				app.SysNotifyManager().ShowSysMsg('未勾选一痞二癞玩法');
		        return;
		    }
		}
		else if ('wanfa' == key) {
			if(toggleIndex == 1 && this.Toggles['difen'][3].getChildByName('checkmark').active){
		        this.Toggles['difen'][3].getChildByName('checkmark').active = false;
		        this.Toggles['difen'][0].getChildByName('checkmark').active = true;
		        this.UpdateLabelColor(this.Toggles['difen'][3].parent);
		    }
		}
    ...
    UpdateOnClickToggle: function() {
        ...
        if(this.Toggles["wanfa"]){
            ...
            if(!this.Toggles["wanfa"][1].getChildByName("checkmark").active){
                this.Toggles['fengDing'][3].getChildByName("checkmark").active = false;
                this.Toggles['fengDing'][4].getChildByName("checkmark").active = false;
                this.Toggles['fengDing'][5].getChildByName("checkmark").active = false;
                //置灰
                if(this.Toggles['fengDing'][3].getChildByName("label")){
                    this.Toggles['fengDing'][3].getChildByName("label").color = cc.color(180, 180, 180);
                }
                if(this.Toggles['fengDing'][4].getChildByName("label")){
                    this.Toggles['fengDing'][4].getChildByName("label").color = cc.color(180, 180, 180);
                }
                if(this.Toggles['fengDing'][5].getChildByName("label")){
                    this.Toggles['fengDing'][5].getChildByName("label").color = cc.color(180, 180, 180);
                }
                //恢复
            ...
            if(!this.Toggles["wanfa"][0].getChildByName("checkmark").active){
                this.Toggles['fengDing'][0].getChildByName("checkmark").active = false;
                this.Toggles['fengDing'][1].getChildByName("checkmark").active = false;
                this.Toggles['fengDing'][2].getChildByName("checkmark").active = false;
                //置灰
                if(this.Toggles['fengDing'][0].getChildByName("label")){
                    this.Toggles['fengDing'][0].getChildByName("label").color = cc.color(180, 180, 180);
                }
                if(this.Toggles['fengDing'][1].getChildByName("label")){
                    this.Toggles['fengDing'][1].getChildByName("label").color = cc.color(180, 180, 180);
                }
                if(this.Toggles['fengDing'][2].getChildByName("label")){
                    this.Toggles['fengDing'][2].getChildByName("label").color = cc.color(180, 180, 180);
                }
                //恢复
                if(this.Toggles['fengDing'][3].getChildByName("label")){
                    this.Toggles['fengDing'][3].getChildByName("label").color = cc.color(158, 49, 16);
                }
                if(this.Toggles['fengDing'][4].getChildByName("label")){
                    this.Toggles['fengDing'][4].getChildByName("label").color = cc.color(158, 49, 16);
                }
                if(this.Toggles['fengDing'][5].getChildByName("label")){
                    this.Toggles['fengDing'][5].getChildByName("label").color = cc.color(158, 49, 16);
                }
            }else{
                //恢复
                if(this.Toggles['fengDing'][0].getChildByName("label")){
                    this.Toggles['fengDing'][0].getChildByName("label").color = cc.color(158, 49, 16);
                }
                if(this.Toggles['fengDing'][1].getChildByName("label")){
                    this.Toggles['fengDing'][1].getChildByName("label").color = cc.color(158, 49, 16);
                }
                if(this.Toggles['fengDing'][2].getChildByName("label")){
                    this.Toggles['fengDing'][2].getChildByName("label").color = cc.color(158, 49, 16);
                }
            }
        }
    },
