...
cc.Class({
    ...
    ShowPlayerData:function(setEnd,playerAll,index){
        ...
        //罚分
        this.node.getChildByName("lb_fafenTitle").active = setEnd.isFaFen || false;
        this.node.getChildByName("lb_fafen").active = setEnd.isFaFen || false;
        if(setEnd.isFaFen){
            this.node.getChildByName("lb_fafen").getComponent(cc.Label).string = point;
        }
