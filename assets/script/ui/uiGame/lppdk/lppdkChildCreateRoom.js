    ...
    UpdateOnClickToggle: function() {
        ...
        if(this.Toggles["fangjian"]){
            ...
            if(!this.Toggles["fafen"][4].getChildByName("checkmark").active){
                ...
                //置灰
                if(this.Toggles['fangjian'][1].getChildByName("label")){
                    this.Toggles['fangjian'][1].getChildByName("label").color = cc.color(180, 180, 180);
                }
                //置灰
                ...
                //恢复
                if(this.Toggles['fangjian'][1].getChildByName("label")){
                    this.Toggles['fangjian'][1].getChildByName("label").color = cc.color(158, 49, 16);
                }
                if(this.Toggles['fangjian'][2].getChildByName("label")){
                    this.Toggles['fangjian'][2].getChildByName("label").color = cc.color(158, 49, 16);
                }
            }
        }
    },
