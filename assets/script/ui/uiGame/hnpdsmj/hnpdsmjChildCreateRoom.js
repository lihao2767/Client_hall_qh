...
var wzmjChildCreateRoom = cc.Class({
    ...
    OnToggleClick:function(event){
        ...
        if('jushu' == key || 'renshu' == key || 'fangfei' == key){
            ...
            if(toggleIndex == 2 && this.Toggles['kexuanwanfa'][12].getChildByName('checkmark').active){
            ...
            if(toggleIndex == 12 && !needClearList[toggleIndex].getChildByName('checkmark').active){
                if(!this.Toggles['baoting'][0].getChildByName('checkmark').active){
                    this.Toggles["baoting"][0].getChildByName("checkmark").active = true;
                    this.Toggles["baoting"][1].getChildByName("checkmark").active = false;
                    this.Toggles["baoting"][2].getChildByName("checkmark").active = false;
                    this.UpdateLabelColor(this.Toggles["baoting"][0].parent);
                }
            }
        }
