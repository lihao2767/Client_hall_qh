            ...
            /*if(this.Toggles["difen"][0].getChildByName("checkmark").active
                ...
                if(this.Toggles['kexuanwanfa'][6].getChildByName("label")){
                	if(this.Toggles['kexuanwanfa'][6].getChildByName("checkmark").active){
                		this.Toggles['kexuanwanfa'][6].getChildByName("label").color = this.RedColor1;
                	}else{
                		this.Toggles['kexuanwanfa'][6].getChildByName("label").color = this.RedColor2;
                	}
                }
            }*/
            //“去掉34”仅限四人场可选。
            ...
            if(!this.Toggles["renshu"][0].getChildByName("checkmark").active){
                ...
                if(this.Toggles['kexuanwanfa'][3].getChildByName("label")){
                	if(this.Toggles['kexuanwanfa'][3].getChildByName("checkmark").active){
                		this.Toggles['kexuanwanfa'][3].getChildByName("label").color = this.RedColor1;
                	}else{
                		this.Toggles['kexuanwanfa'][3].getChildByName("label").color = this.RedColor2;
                	}
                }
            }
        }
