...
var sjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		...
		if (!this.CheckEditBoxData("jiesanfafen")) {
			// app[app.subGameName + "_SysNotifyManager"]().ShowSysMsg('请检查输入的区间值是否正确');
			return null;
		}
		...
		let jiamaishu = this.GetIdxByKey('jiamaishu');
		let jiesansuanjiang = this.GetIdxByKey('jiesansuanjiang');
		let jiesanfafen = this.GetEditBoxByKey('jiesanfafen');
