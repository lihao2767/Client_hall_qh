...
cc.Class({
	...
	ShowOtherScore: function(ShowNode, huInfo) {
        ...
        let zhuangPoint = huInfo["zhuangPoint"] || 0;
        ShowNode.getChildByName('genzhuangLb').getComponent("cc.Label").string = "跟庄分:" + this.ToUiScore(zhuangPoint);

		let MaPoint = huInfo["zhongMaPoint"] || 0;
        ShowNode.getChildByName('mafenLb').getComponent("cc.Label").string = "马分:" + this.ToUiScore(MaPoint);
    },
	...
	ShowPlayerHuaCard: function (huacardscrollView, hualist) {
		...
		UICard_ShowCard.Show12HuaList(hualist);
	},
