...
cc.Class({
	...
	ShowOtherScore: function(ShowNode, huInfo) {
        ...
        let gangFen = huInfo["gangPoint"] || 0;
        ShowNode.getChildByName('gangfenLb').getComponent("cc.Label").string = "杠分" + this.ToUiScore(gangFen);

        let maiDianPoint = huInfo["maiDianPoint"] || 0;
        ShowNode.getChildByName('maifenLb').getComponent("cc.Label").string = "买点分" + this.ToUiScore(maiDianPoint);
