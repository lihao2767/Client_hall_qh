...
cc.Class({
    ...
    ShowPlayerInfo: function (ShowNode, PlayerInfo, HuList) {
        ...
        ShowNode.getChildByName('icon_baopai').active = HuList["isBao"] || false;
        ShowNode.getChildByName('icon_beibaopai').active = HuList["isBeiBao"] || false;
    },
    ...
    ShowOtherScore: function(ShowNode, huInfo) {
        ...
        ShowNode.getChildByName('hupaifenLb').getComponent("cc.Label").string = "胡牌分：" + this.ToUiScore(huPaiPoint);
    },
