...
var jschChildCreateRoom = cc.Class({
	extends: require("BaseChildCreateRoomNew"),
    ...
    CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        ...
        if (!this.GetEditBoxByKey('difen')) {
            app["SysNotifyManager"]().ShowSysMsg('请检查输入的区间值是否为1-20整数');
            return;
        }else{
...
module.exports = jschChildCreateRoom;