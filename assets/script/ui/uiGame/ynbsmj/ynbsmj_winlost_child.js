...
cc.Class({
	...
	ShowPlayerInfo: function (ShowNode, PlayerInfo, HuList) {
        ...
        let maidi = HuList["piao"] || -1;
        ShowNode.getChildByName('icon_maidi').active = maidi > 0;
		if(maidi > 0){
			ShowNode.getChildByName('icon_maidi').getChildByName("label").getComponent(cc.Label).string = "买" + maidi + "点";
		}
    },
	...
	LabelName: function (huType) {
		...
		huTypeDict["QGH"]="抢杠胡";
		huTypeDict["ZYS"]="字一色";
		huTypeDict["PiaoHua"]="死点";
		huTypeDict["PiaoFen"]="活点``";
