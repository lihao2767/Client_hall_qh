...
cc.Class({
	...
	ShowOtherScore: function(ShowNode, huInfo) {
        ...
        ShowNode.getChildByName('taiLb').getComponent("cc.Label").string = "台:" + taiShu;

        let huaShu = huInfo["huaShu"] || 0;
        ShowNode.getChildByName('huaLb').getComponent("cc.Label").string = "花:" + huaShu;

        let zongTiaoShu = huInfo["zongTiaoShu"] || 0;
        ShowNode.getChildByName('tiaoLb').getComponent("cc.Label").string = "条:" + zongTiaoShu;
    },
	...
	LabelName: function (huType) {
		...
		huTypeDict["TH"]="天胡";
		huTypeDict["DH"]="地胡";
		huTypeDict["CSDD"]="财神单吊";
		huTypeDict["DDCS"]="单吊财神";
		huTypeDict["CSZN"]="财神做牛";
		huTypeDict["SMP"]="三明牌";
		huTypeDict["SCS"]="三财神";
		huTypeDict["SBB"]="四白板";
		huTypeDict["SCSK"]="三财神刻";
		huTypeDict["SiCS"]="四财神";
		huTypeDict["CSSGW"]="财神双归位";
		huTypeDict["CSSanGW"]="财神三归位";
		huTypeDict["CSSiGW"]="财神四归位";
		huTypeDict["CSAG"]="财神暗杠";
		huTypeDict["BZ"]="半字";
		huTypeDict["CSGW"]="财神归位";
		huTypeDict["WCS"]="无财神";
		huTypeDict["QGH"]="抢杠胡";
