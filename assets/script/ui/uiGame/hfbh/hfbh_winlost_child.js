...
cc.Class({
	...
	OnLoad: function () {
        ...
        this.IntegrateImagePath={
            "zi_fang_11": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/11",
            },
            "zi_fang_12": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/12",
            },
            "zi_fang_13": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/13",
            },
            "zi_fang_14": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/14",
            },
            "zi_fang_15": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/15",
            },
            "zi_fang_16": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/16",
            },
            "zi_fang_17": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/17",
            },
            "zi_fang_18": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/18",
            },
            "zi_fang_19": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/19",
            },
            "zi_fang_21": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/21",
            },
            "zi_fang_22": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/22",
            },
            "zi_fang_23": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/23",
            },
            "zi_fang_24": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/24",
            },
            "zi_fang_25": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/25",
            },
            "zi_fang_26": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/26",
            },
            "zi_fang_27": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/27",
            },
            "zi_fang_28": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/28",
            },
            "zi_fang_29": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/29",
            },
            "zi_fang_31": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/31",
            },
            "zi_fang_32": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/32",
            },
            "zi_fang_33": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/33",
            },
            "zi_fang_34": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/34",
            },
            "zi_fang_35": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/35",
            },
            "zi_fang_36": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/36",
            },
            "zi_fang_bg": {
                "FilePath": "ui/uiGame/hfbh/zi/fangxing/0",
            },
    ...
    ShowPlayerData:function(setEnd,playerAll,index){
        ...
        this.jiangPaiList = setEnd["jiangPaiList"];
    ...
    PlayerData:function(PlayerNode,result,pos){
        ...
        for(let i=0;i<cardPublicMap.length;i++){
            ...
            if (opType ==1) {
                ...
                addYou.getChildByName("lb_optype").getComponent(cc.Label).string="招";
            }else if (opType == 5) {
                addYou.getChildByName("lb_optype").getComponent(cc.Label).string="招";
            }else if (opType == 6) {
                addYou.getChildByName("lb_optype").getComponent(cc.Label).string="跳";
            }else if (opType == 7) {
                ...
                addYou.getChildByName("lb_optype").getComponent(cc.Label).string="挂";
            }else{
        ...
        // lb_fanshu.getComponent(cc.Label).string = "番数:" + this.ToUiScore(result.fanShu);
        ...
        let huPoint = huTypeMap["HuShu"];
        if (typeof(huPoint)!="undefined") {
            lb_hushu.getComponent(cc.Label).string=huTypeDict["HuShu"]+"：" + huPoint;
        }else{
            lb_hushu.getComponent(cc.Label).string="";
        }
        let piaoFenPoint = huTypeMap["PiaoFen"];
        if (typeof(piaoFenPoint)!="undefined") {
            lb_fanshu.getComponent(cc.Label).string=huTypeDict["PiaoFen"]+"：" + piaoFenPoint;
        }else{
            lb_fanshu.getComponent(cc.Label).string="";
        }
        let wuJiangFanFan = huTypeMap["WuJiangFanFan"];
        if (typeof(wuJiangFanFan)!="undefined") {
            lb_qiangshu.getComponent(cc.Label).string=huTypeDict["WuJiangFanFan"];
        }else{
            lb_qiangshu.getComponent(cc.Label).string="";
        }
    },
    ...
    ShowOutCardImage:function(childNode){
        childNode.active=true;
            ...
            if (this.jiangPaiList.indexOf(Math.floor(childNode.cardID/100)) >= 0) {
                childNode.getChildByName("icon_jin").active=true;
            }else{
                childNode.getChildByName("icon_jin").active=false;
            }
