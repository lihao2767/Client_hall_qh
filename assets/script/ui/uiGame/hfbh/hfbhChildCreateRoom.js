...
var hhhgwChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        ...
        let fangpao=this.GetIdxByKey('fangpao');
        ...
        if('jushu' == key || 'renshu' == key || 'fangfei' == key){
            ...
            if(key=="renshu"){
                if(toggleIndex==1){
                    ...
                    this.UpdateLabelColor(this.Toggles['qihu'][1].parent);
            ...
            if(toggleIndex==1 && this.Toggles['renshu'][1].getChildByName('checkmark').active == true){
                 app.SysNotifyManager().ShowSysMsg('3人场不能勾选“50息起胡”');
                 return;
            }
        }
        else if('kexuanwanfa' == key){
            if(toggleIndex==4 && this.Toggles['renshu'][1].getChildByName('checkmark').active == true){
                 app.SysNotifyManager().ShowSysMsg('3人场不能勾选“不翻将”');
                 return;
            }
