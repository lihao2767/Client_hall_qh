        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (this.Toggles['moshi'][2].getChildByName('checkmark').active==false) {
                 if (toggleIndex == 0 && this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active==false) {
                     app.SysNotifyManager().ShowSysMsg("比奖模式才能全托",[],3);
                     return;
                 }
             }
            if (this.Toggles['moshi'][2].getChildByName('checkmark').active==true) {
                 if (toggleIndex == 2 && this.Toggles['kexuanwanfa'][2].getChildByName('checkmark').active==false) {
                      app.SysNotifyManager().ShowSysMsg("2人比奖模式不能选40张手牌",[],3);
                     return;
                 }
             }
