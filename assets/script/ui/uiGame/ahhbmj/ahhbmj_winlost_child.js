...
cc.Class({
    ...
    ShowPlayerInfo: function (ShowNode, PlayerInfo, HuList) {
        ShowNode.getChildByName('lb_laFen').getComponent(cc.Label).string = HuList.laFen == -1 ? "" : "拉" + HuList.laFen;
        ShowNode.getChildByName('lb_paoFen').getComponent(cc.Label).string = HuList.paoFen == -1 ? "" : "跑" + HuList.paoFen;
        ShowNode.getChildByName('lb_zuoFen').getComponent(cc.Label).string = HuList.zuoFen == -1 ? "" : "坐" + HuList.zuoFen;
