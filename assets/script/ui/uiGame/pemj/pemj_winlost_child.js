...
cc.Class({
    ...
    IsNoShowScore: function (huType) {
        let multi2 = ["MenQing1","QD1","LQD","SLQD","SanLQD","PPHu1","QYS1","QF1","SF1","QX1","GSKH1","GSP1","QGH1","ZFB"];
    ...
    ShowPlayerDownCard: function (ShowNode, publishcard, jin1 = 0, jin2 = 0) {
        ...
        UICard_DownCard.ShowDownCardByPEMJ(publishcard, this.posCount, jin1, jin2);
    },
    ...
    GetHuTypeDict: function () {
        ...
        //"//番"
        huTypeDict["MenQing1"]="门清";
        huTypeDict["QD1"]="七对";
        huTypeDict["LQD"]="龙七对";
        huTypeDict["SLQD"]="双龙七对";
        huTypeDict["SanLQD"]="三龙七对";
        huTypeDict["PPHu1"]="碰碰胡";
        huTypeDict["QYS1"]="清一色";
        huTypeDict["QF1"]="全风";
        huTypeDict["SF1"]="十风";
        huTypeDict["QX1"]="七星";
