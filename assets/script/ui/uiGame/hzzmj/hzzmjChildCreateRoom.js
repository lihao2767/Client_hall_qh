...
var hzzmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		let sendPack = {};
        let difenwanfa=this.GetIdxByKey('difenwanfa');
        ...
        let mafenguize=this.GetIdxsByKey('mafenguize');
        let kaima=this.GetIdxByKey('kaima');
        ...
        sendPack = {
            "difenwanfa":difenwanfa,
            "guipai":guipai,
            "jiabei":jiabei,
            "dingzhuang":dingzhuang,
            "lunzhuang":lunzhuang,
            "maima":maima,
            "mafenguize":mafenguize,
            "kaima":kaima,
