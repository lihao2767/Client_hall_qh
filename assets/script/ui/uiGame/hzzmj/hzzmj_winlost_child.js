...
cc.Class({
	...
	IsShowNum: function (huType) {
		let multi2 = ["GBQB", "ChiSanBi"];
		let isShow = multi2.indexOf(huType) != -1;
		return isShow;
	},
	//倍数
	IsShowMulti2: function (huType) {
		let multi2 = ["QiangGangHu", "GSKH", "ZiMo", "WuHua", "BaHuaHu", "QiHuaHu", "SiHuaHu", "HuaDanDiao", "HuaDiaoHu", "MQ", "QQR"];
		let isShow = multi2.indexOf(huType) != -1;
		return isShow;
	},
	LabelName: function (huType) {
        let huTypeDict = {};
		huTypeDict["PingHu"]="鸡胡";
		huTypeDict["QD"]="七小对";
		huTypeDict["SSHHQD"]="三豪华七小对";
		huTypeDict["SHHQD"]="双豪华七小对";
		huTypeDict["HHQD"]="豪华七小对";
		huTypeDict["SSY"]="十三幺";
		...
		huTypeDict["ZiMo"]="自摸";
		huTypeDict["WuHua"]="无花";
		huTypeDict["BaHuaHu"]="八花胡";
		huTypeDict["QiHuaHu"]="七花胡";
		huTypeDict["SiHuaHu"]="四花胡";
		huTypeDict["HuaDanDiao"]="花单吊";
		huTypeDict["HuaDiaoHu"]="花吊花";
    ...
    ShowPlayerShowCard: function (ShowNode, cardIDList, handCard, jin1, jin2) {
        ...
        UICard_ShowCard.ShowDownCardByHZZMJ(cardIDList, handCard, jin1, jin2);
    },
});
