...
var dxhftmjChildCreateRoom = cc.Class({
	...
	OnToggleClick: function (event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			if (this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active && toggleIndex == 2) {
				this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active = false;
				this.UpdateLabelColor(this.Toggles['kexuanwanfa'][1].parent);
			} else if (this.Toggles['kexuanwanfa'][2].getChildByName('checkmark').active && toggleIndex == 1) {
...
module.exports = dxhftmjChildCreateRoom;