...
cc.Class({
    ...
    LoadImg:function(index = 0){
        ...
        if(cc.sys.isNative){
            this.imgUrl ="http://8.159.141.75:88" + this.dataInfo[index]['propaganda'];
        }else{
            this.imgUrl ="http://8.159.141.75:88" + this.dataInfo[index]['propaganda'];
        }
        // let imgUrl = "http://8.159.141.75/myimg.php?url=" + url;
    ...
    InitGameBtnList: function (serverPack) {
        this.FormManager.ShowForm("UICreatRoomNew", serverPack);
    },
    OnClick:function(btnName,btnNode){
        if('btn_close' == btnName){
            ...
            else if(sceneName == "UICreatRoomNew"){
