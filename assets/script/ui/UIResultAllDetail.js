...
cc.Class({
    ...
    OnShow: function (basedata = false, playerlist = false, gameType = "", unionId = 0) {
        ...
        if (Type == 1) {
            ...
            if (this.gameType == app.ShareDefine().GametTypeID2PinYin[app.ShareDefine().GameType_XLBBP] || this.gameType == app.ShareDefine().GametTypeID2PinYin[app.ShareDefine().GameType_QXWQ]) {
                // this.poker_title_list.active = false;
            ...
            if (this.gameType == app.ShareDefine().GametTypeID2PinYin[app.ShareDefine().GameType_SDH] ||
                this.gameType == app.ShareDefine().GametTypeID2PinYin[app.ShareDefine().GameType_CDP] ||
                this.gameType == app.ShareDefine().GametTypeID2PinYin[app.ShareDefine().GameType_HNDZP] ||
                this.gameType == app.ShareDefine().GametTypeID2PinYin[app.ShareDefine().GameType_LCZP]) {
                this.mj_layout_player.active = true;
                this.poker_layout_player.active = false;
                this.layout_player = this.mj_layout_player;
                this.poker_title_list.active = false;
