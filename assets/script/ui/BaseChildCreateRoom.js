...
var BaseChildCreateRoom = cc.Class({
    ...
    RefreshAllTogglesFormServer:function(gameType,gameCreateConfig,roomcostConfig){
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (let i = 0; i < curCostData.length; i++) {
                                this.Toggles['jushu'][i%3].getChildByName('label').getComponent(cc.Label).string = curCostData[i].SetCount + '局';
                            }
                        }
