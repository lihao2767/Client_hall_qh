...
cc.Class({
    ...
    OnCreateInit: function () {
        ...
        this.httpPath = "cdnstore3.qicaiqh.com";
    ...
    OnShow: function (openViewName = 'btn_table1') {
        ...
        app.NetManager().SendPack("family.CPlayerCheckFamilyOwner",{},function(success){
            let signString="wanzi"+allSelectCityData[0]['selcetId'];
            let sign = app.MD5.hex_md5(signString);
            if (success.vip < 0) {
                that.SendHttpRequest('http://'+that.httpPath+'/index.php?module=MallCenter&action=GetMallGoods', "&gamename=qinghuai&goodstype=2&sign="+sign+"&cityId="+allSelectCityData[0]['selcetId'], "GET",{});
            }else{
                if(success.vip==0){
                    that.SendHttpRequest('http://'+that.httpPath+'/index.php?module=MallCenter&action=GetMallGoods', "&gamename=qinghuai&goodstype=4&sign="+sign+"&cityId="+allSelectCityData[0]['selcetId'], "GET",{});
                }else if(success.vip==1){
                    that.SendHttpRequest('http://'+that.httpPath+'/index.php?module=MallCenter&action=GetMallGoods', "&gamename=qinghuai&goodstype=5&sign="+sign+"&cityId="+allSelectCityData[0]['selcetId'], "GET",{});
                }else if(success.vip==2){
                    that.SendHttpRequest('http://'+that.httpPath+'/index.php?module=MallCenter&action=GetMallGoods', "&gamename=qinghuai&goodstype=6&sign="+sign+"&cityId="+allSelectCityData[0]['selcetId'], "GET",{});
                }else if(success.vip==3){
                    that.SendHttpRequest('http://'+that.httpPath+'/index.php?module=MallCenter&action=GetMallGoods', "&gamename=qinghuai&goodstype=7&sign="+sign+"&cityId="+allSelectCityData[0]['selcetId'], "GET",{});
                }
            }
        },function(error){
            let signString2="wanzi"+allSelectCityData[0]['selcetId'];
            let sign2 = app.MD5.hex_md5(signString2);
            that.SendHttpRequest('http://'+that.httpPath+'/index.php?module=MallCenter&action=GetMallGoods', "&gamename=qinghuai&goodstype=2&sign="+sign2+"&cityId="+allSelectCityData[0]['selcetId'], "GET",{});
        });
    ...
    */
    ...
    OnBuyBtnClick:function(event){
        ...
        if(this.curRefreshTabel == this.RefreshType.leDou){
            ...
            let signString="wanzi"+app.HeroManager().GetHeroID()+this.appID;
            let sign = app.MD5.hex_md5(signString);
            cc.sys.openURL("http://"+this.httpPath+"/index.php?module=MallPay&action=NewPay&sign="+sign+"&goodsID="+this.appID+"&playerID="+app.HeroManager().GetHeroProperty("pid")+"&cityId="+allSelectCityData[0]['selcetId']);
