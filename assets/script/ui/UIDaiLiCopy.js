...
cc.Class({
    ...
    OnCreateInit: function () {
        this.POSTURL="http://8.159.141.75/index.php?module=ApplicationAgent&action=setApply";
        this.GETURL="http://8.159.141.75/index.php?module=ApplicationAgent&action=getApply&playerID="+app.HeroManager().GetHeroProperty("pid");
    ...
    */
    ...
    click_btn_yzm:function(){
        ...
        this.yanzhengUrl="http://8.159.141.75:88/index.php?module=Sms&action=SendCode";
