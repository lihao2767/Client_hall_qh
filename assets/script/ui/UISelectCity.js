...
cc.Class({
    ...
    OnCreateInit: function () {
        ...
        this.RegEvent("ShowGameListByLocation", this.CloseForm, this);
    ...
    OnShow: function () {
        ...
        this.SelectId = 1260501;  //1080901;   //默认选择的城市  阳阳改 指定城市
 ...
 */
        // 阳阳添加，指定固定城市 
        this.OnClick("btn_starGame", ""); //开始直接指定城市 这里直接调用关闭
        ...
        this.SendHttpRequest('http://8.159.141.75:88/myipaddress.php', "", "GET", {});
    ...
    ShowAllCity: function () {
        ...
        for (let key in this.selectCityConfig) {
            if (this.selectCityConfig[key][appName] == 1 || !cc.sys.isNative) {
    ...
    OnClick: function (btnName, btnNode) {
        if ('btn_search' == btnName) {
            ...
            app.Client.GetGameListByCityId(this.SelectId);
