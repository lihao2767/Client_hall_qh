...
cc.Class({
	...
	SetPlayerInfo: function (key, record) {
		...
		if (this.datainfo) {
			...
			if (this.unionId > 0) {
				...
				if (this.ShareDefine.GameType_QJWSKBD == this.gameType) {
					if (sportsPoint > 0) {
						this.SetWndProperty("lb_chengji_win", "text", '+' + sportsPoint);
						this.SetWndProperty("lb_chengji_win", "active", true);
					} else {
						this.SetWndProperty("lb_chengji_lost", "text", sportsPoint);
						this.SetWndProperty("lb_chengji_lost", "active", true);
					}
				}
			} else {
	...
	OnClick_ShowMore: function () {
		...
		if (this.ShareDefine.GameType_XGCGMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		...
		if (this.ShareDefine.GameType_WSBEA == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		...
		if (this.ShareDefine.GameType_LPTS == this.gameType) {
			...
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}if (this.ShareDefine.GameType_YFBS == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		...
		if (this.ShareDefine.GameType_HSHHMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_DYKKFMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_HZZMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_XLBBP == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_SDDMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_YXMDMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_KJMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_WXQWZMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_QXWQ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_GDCSMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_QYYBZMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
		}
		if (this.ShareDefine.GameType_GDYBZMJ == this.gameType) {
			let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
			let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
			this.FormManager.ShowForm(path, this.record.roomId, this.playerList, this.gameType, this.unionId);
			return;
	...
	OnClick_ShowAll: function () {
		if (this.datainfo) {
			...
			if (this.ShareDefine.GameType_JSCH == this.gameType) {
				let smallName = this.ShareDefine.GametTypeID2PinYin[this.gameType];
				let path = "ui/uiGame/" + smallName + "/UIResultAllDetail_" + smallName;
				this.FormManager.ShowForm(path, this.datainfo, this.playerList, this.gameType, this.unionId);
				return;
