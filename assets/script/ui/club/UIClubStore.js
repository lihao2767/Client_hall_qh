    ...
    */
    ...
    OnConFirm:function(clickType, msgID, backArgList){
        ...
        if('MSG_CLUB_Store' == msgID){
            cc.sys.openURL("http://8.159.141.75/index.php?module=WxPay&action=MWEB_Pay&goodsID="+this.AppID+"&playerID="+app.HeroManager().GetHeroProperty("pid")+"&clubId="+this.nowClubID);
        }
    },
