...
cc.Class({
	...
	OnClick:function(btnName, btnNode){
		if('btn_close'==btnName){
            ...
            this.SetWaitForConfirm('SURE_PROMOTER_SET',this.ShareDefine.Confirm,[],[], "修改从属后该推广员及分支下原数据会归属到当前上级身上，修改后产生的新数据会在新上级那边，且如活跃系数类型与新上级不一致将强制修改类型并默认为0，请确认数据是否已清楚并修改");
            // let self = this;
