...
        var today = new Date();
    ...
    UpdateScrollView:function(serverPack, isRefresh){
        ...
        for (let i = 0; i < serverPack.length; i++) {
            ...
            app.RoomCfgManager().WanFaFormServer(gameType,cfgObj,child.getChildByName("lb_roomCfg").getComponent(cc.Label),0,'',child);
            //app.RoomCfgManager().WanFa(gameType,cfgObj);
	...
	OnClick:function(btnName, btnNode){
		if('btn_close'==btnName){
            ...
            app.FormManager().ShowForm("ui/club/UIUnionRoomCfgMsg", wanfaStr,'');
        }
	},
});
