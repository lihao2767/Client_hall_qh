...
cc.Class({
    ...
    OnClick:function(btnName, btnNode){
        if('btn_next'==btnName){
        	...
        	app.FormManager().ShowForm("UICreatRoomNew",{"gameList":app.Client.GetAllGameId()},"",null,sendPack);
            ...
            app.FormManager().ShowForm("UICreatRoomNew",{"gameList":app.Client.GetAllGameId()},gameType,null,sendPack);
    ...
    UndateRoomCfgInfo:function(serverPack, cfgNode){
        ...
        PLDecStr += "，比赛分低于"+serverPack.bRoomConfigure.autoDismiss+"自动解散";
        ...
        app.RoomCfgManager().WanFaFormServer(serverPack.gameId,serverPack.bRoomConfigure,cfgNode.getChildByName("lb_wanfa").getComponent(cc.Label));
