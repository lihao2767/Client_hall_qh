...
cc.Class({
    ...
    UpdateData:function(serverPack){
        ...
        let HuoYueContainer = this.content.getChildByName("HuoYueContainer");
        if (serverPack.promotionShow == 0) {
            HuoYueContainer.getChildByName("huoyueToggle1").getComponent(cc.Toggle).isChecked = true;
        }else{
            HuoYueContainer.getChildByName("huoyueToggle2").getComponent(cc.Toggle).isChecked = true;
        }

        let shoujiContainer = this.content.getChildByName("shoujiContainer");
        if (serverPack.banPhoneUser == 0) {
            shoujiContainer.getChildByName("shoujiToggle1").getComponent(cc.Toggle).isChecked = true;
        }else{
            shoujiContainer.getChildByName("shoujiToggle2").getComponent(cc.Toggle).isChecked = true;
        }
        ...
        let duijushuToggleContainer = this.content.getChildByName("duijushuToggleContainer");
        if (duijushuToggleContainer) {
            if (serverPack.showRecordCount == 0) {
                duijushuToggleContainer.getChildByName("AllowToggle1").getComponent(cc.Toggle).isChecked = false;
                duijushuToggleContainer.getChildByName("AllowToggle2").getComponent(cc.Toggle).isChecked = true;
            }else{
                duijushuToggleContainer.getChildByName("AllowToggle2").getComponent(cc.Toggle).isChecked = false;
                duijushuToggleContainer.getChildByName("AllowToggle1").getComponent(cc.Toggle).isChecked = true;
            }
        }
    ...
    GetSetConfig:function(){
        ...
        let HuoYueContainer = this.content.getChildByName("HuoYueContainer");
        if (HuoYueContainer.getChildByName("huoyueToggle1").getComponent(cc.Toggle).isChecked) {
            sendPack.promotionShow = 0;
        }else{
            sendPack.promotionShow = 1;
        }

        let shoujiContainer = this.content.getChildByName("shoujiContainer");
        if (shoujiContainer.getChildByName("shoujiToggle1").getComponent(cc.Toggle).isChecked) {
            sendPack.banPhoneUser = 0;
        }else{
            sendPack.banPhoneUser = 1;
        }
        ...
        let duijushuToggleContainer = this.content.getChildByName("duijushuToggleContainer");
        if (duijushuToggleContainer) {
            if (duijushuToggleContainer.getChildByName("AllowToggle1").getComponent(cc.Toggle).isChecked) {
                sendPack.showRecordCount = 1;
            }else{
                sendPack.showRecordCount = 0;
            }
        }
