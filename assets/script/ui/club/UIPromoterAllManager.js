        ...
        for (let i = 0; i < content.children.length; i++) {
            if (content.children[i].y + gundongY > -1300) {
                ...
                if (content.children[i].isDisplay == false) {
                    ...
                    this.ShowOrHideDataNode(toptitle.getChildByName("lb_13"), dataNode.getChildByName("lb_spWarningPromoter"), serverPack.sportsPointWarning, 5);//推广员预警值  阳阳改，讲原来的9改为5
                    ...
                    this.ShowOrHideDataNode(toptitle.getChildByName("lb_8"), dataNode.getChildByName("lb_costZuan"), serverPack.consume, 9);
                    // 阳阳改 将原来的5改成9
                    ...
                    dataNode.getChildByName('img_head').getChildByName("img_guanli").active = serverPack.isPromotionManage > 0;
