...
cc.Class({
    ...
    UpdateScrollView:function(serverPack, isRefresh){
        ...
        for (let i = 0; i < unionBanRoomConfigBOList.length; i++) {
            ...
            app.RoomCfgManager().WanFaFormServer(gameType,cfgObj,child.getChildByName("img_bj").getChildByName("lb_roomCfg").getComponent(cc.Label),16,this.GetUnionCfg(cfgObj),child);
           // child.wanfa = wanfa;
