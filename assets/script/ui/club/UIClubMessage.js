...
cc.Class({
    ...
    OnCreateInit:function(){
        ...
        */
         ...
         * 被修改比赛卷
         */
        this.UNION_CHANGE_BISAIJUAN= 1025;
    },
            ...
            if(content.children[i].y+gundongY>-1300){ 
                ...
                if(content.children[i].isDisplay==false){
                    ...
                    switch(this.serverPack[i].execType){
                        ...
                        case this.UNION_CHANGE_BISAIJUAN:
                            msgStr = execNameStr+this.actionColor+"修改</c>了"+NameStr+"的比赛券为"+this.valueColor+this.serverPack[i].curValue+"，修改前为"+this.serverPack[i].preValue;
                            break;
                        ...
                        case this.UNION_EXEC_SHARE_SECTION:
                            msgStr = clubNameStr+NameStr+"被"+execNameStr+this.actionColor+"修改</c>了亲友圈活跃度计算为"+this.valueColor+"区间系数"+"</c>";
                            break;
                        default:
