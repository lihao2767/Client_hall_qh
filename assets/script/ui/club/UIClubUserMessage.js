                    ...
                    switch(this.serverPack[i].execType){
                        ...
                        case this.UNION_EXEC_BILI_CHANGE:
                            if (typeof(this.serverPack[i].msg) != "undefined") {
                                msgStr = NameStr+"因上级推广员修改"+this.actionColor+"报名费"+this.valueColor+this.serverPack[i].msg+"</c>系数，之前"+this.valueColor+this.serverPack[i].curValue+","+"当前为："+this.serverPack[i].value+"</c>";
                            }else{
                                msgStr = NameStr+"因上级推广员修改"+this.actionColor+"报名费</c>系数，之前"+this.valueColor+this.serverPack[i].curValue+","+"当前为："+this.serverPack[i].value+"</c>";
                            }
                            break;
                        case this.UNION_EXEC_RESERVED_VALUE_CHANGE:
                            msgStr = clubNameStr+NameStr+"被上级推广员"+execClubNameStr+execNameStr+this.actionColor+"通过预留设置修改</c>了活跃系数";
                            break;
