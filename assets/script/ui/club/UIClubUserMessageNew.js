...
cc.Class({
    ...
    OnCreateInit:function(){
        ...
        */
        ...
        1008,
        /**
         * 推广员竞技点收益收入系数到保险箱UNION_EXEC_PROMOTION_SHARE_INCOME_CASEPOINT
         */
        1013],
        //输赢比赛分的消息5
        [
        ...
        48,
        /**
         * 亲友圈收益变为区间系数UNION_EXEC_SHARE_SECTION
         */
        49],
        //踢出玩家的消息9
        [
        ...
        [
        /**
         * 推广员区间系数修改PROMOTION_EXEC_SHARE_SECTION_CHANGE
         */
        50,
        /**
         * 推广员区间系数分牌修改PROMOTION_EXEC_SHARE_SECTION_ALLOW_CHANGE
         */
        51],
        //区间系数消息13
        [
