...
cc.Class({
    ...
    OnShow:function(luckDrawData,luckDrawSprs){
        ...
        if (cc.sys.isNative) {
            this.getRecordUrl = "http://8.159.141.75/index.php?module=Api&action=GetLuckRecords&pid="+heroID;
            this.getRecordByTypeUrl = "http://8.159.141.75/index.php?module=Api&action=GetLuckRecords&pid="+heroID+"&type=8";
        }else{
            this.getRecordUrl = "http://8.159.141.75/index.php?module=Api&action=GetLuckRecords&pid="+heroID;
            this.getRecordByTypeUrl = "http://8.159.141.75/index.php?module=Api&action=GetLuckRecords&pid="+heroID+"&type=8";
        }
