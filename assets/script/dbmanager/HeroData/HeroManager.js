...
var HeroManager = app.BaseClass.extend({
    ...
    Init:function(){
        ...
        this.cityGameIdListMap={};


        this.NetManager.RegNetPack("playerchanged", this.OnPack_HeroProperty, this);

        this.NetManager.RegNetPack("SPlayer_RealAuthen", this.OnPack_RealAuthen, this);
    ...
    GetCityGameIdList:function(cityId){
        if(this.cityGameIdListMap[cityId]){
            return this.cityGameIdListMap[cityId];
        }
        return null;
    },
    SetCityGameIdList:function(cityId,data){
        this.cityGameIdListMap[cityId]=data;
    },
    ...
    OnPack_RealAuthen:function(serverPack){
        this.SetHeroProperty('realName', serverPack.realName);
        this.SetHeroProperty('realNumber', serverPack.realNumber);
    },
