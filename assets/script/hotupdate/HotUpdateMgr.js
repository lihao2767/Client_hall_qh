...
var HotUpdateMgr = app.BaseClass.extend({
    ...
    Init: function () {
        ...
        if (this.isHallDownLoad() == true) {
            UIRLFILE = "http://8.159.141.75:82/hall_split_split/remote-assets";
        } else {
            //this.firstDown=true;
            UIRLFILE = "http://8.159.141.75:82/hall_split_split/remote-assets";
        }
    ...
    SaveManifest: function () {
        ...
        let path_Manifest = "http://8.159.141.75:82/hall_split_split/remote-assets/project_item.manifest";
        if(cc.sys.localStorage.getItem('appName')=="jiangxi"){
            //江西渠道包要独立域名
            path_Manifest = "http://8.159.141.75:82/hall_split_split/remote-assets/project_item.manifest";
        }
        if(cc.sys.localStorage.getItem('appName')=="hubei"){
            //江西渠道包要独立域名
            path_Manifest = "http://8.159.141.75:82/hall_split_split/remote-assets/project_item.manifest";
    ...
    UpdateCb: function (event) {
        ...
        var failed = false;
        console.log("ResUpdate UpdateCb event:", event.getEventCode());
