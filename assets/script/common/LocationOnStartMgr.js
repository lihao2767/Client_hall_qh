...
var LocationOnStartMgr = app.BaseClass.extend({
    ...
    OnGetLocationCallBack: function (serverPack) {
        this.SysLog("OnGetLocationCallBack LocationOnStartMgr serverPack:%s", serverPack.toString());
    ...
    OnGetLocation: function () {
        ...
        if (!cc.sys.isNative) {
            ...
            // 定位
            console.log("OnGetLocation NativeManager");
